...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ses.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ses.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ses.dev",
			expectURL:     aws.String("https://env-ses.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ses.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ses.dev",
			expectURL:     aws.String("http://config-ses.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ses.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ses.dev",
			clientEndpoint: aws.String("https://client-ses.dev"),
			expectURL:      aws.String("https://client-ses.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SES", c.envService)
			}
