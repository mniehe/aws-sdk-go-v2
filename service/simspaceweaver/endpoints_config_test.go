...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-simspaceweaver.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-simspaceweaver.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-simspaceweaver.dev",
			expectURL:     aws.String("https://env-simspaceweaver.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-simspaceweaver.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-simspaceweaver.dev",
			expectURL:     aws.String("http://config-simspaceweaver.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-simspaceweaver.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-simspaceweaver.dev",
			clientEndpoint: aws.String("https://client-simspaceweaver.dev"),
			expectURL:      aws.String("https://client-simspaceweaver.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SIMSPACEWEAVER", c.envService)
			}
