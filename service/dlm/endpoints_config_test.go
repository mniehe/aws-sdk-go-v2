...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-dlm.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dlm.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dlm.dev",
			expectURL:     aws.String("https://env-dlm.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-dlm.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dlm.dev",
			expectURL:     aws.String("http://config-dlm.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-dlm.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-dlm.dev",
			clientEndpoint: aws.String("https://client-dlm.dev"),
			expectURL:      aws.String("https://client-dlm.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DLM", c.envService)
			}
