...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-gamelift.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gamelift.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gamelift.dev",
			expectURL:     aws.String("https://env-gamelift.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-gamelift.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gamelift.dev",
			expectURL:     aws.String("http://config-gamelift.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-gamelift.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-gamelift.dev",
			clientEndpoint: aws.String("https://client-gamelift.dev"),
			expectURL:      aws.String("https://client-gamelift.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GAMELIFT", c.envService)
			}
