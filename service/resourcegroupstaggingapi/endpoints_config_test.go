...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-resource-groups-tagging-api.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resource-groups-tagging-api.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resource-groups-tagging-api.dev",
			expectURL:     aws.String("https://env-resource-groups-tagging-api.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-resource-groups-tagging-api.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resource-groups-tagging-api.dev",
			expectURL:     aws.String("http://config-resource-groups-tagging-api.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-resource-groups-tagging-api.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-resource-groups-tagging-api.dev",
			clientEndpoint: aws.String("https://client-resource-groups-tagging-api.dev"),
			expectURL:      aws.String("https://client-resource-groups-tagging-api.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RESOURCE_GROUPS_TAGGING_API", c.envService)
			}
