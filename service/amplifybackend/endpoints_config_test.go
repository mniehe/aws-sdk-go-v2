...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-amplifybackend.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplifybackend.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplifybackend.dev",
			expectURL:     aws.String("https://env-amplifybackend.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-amplifybackend.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplifybackend.dev",
			expectURL:     aws.String("http://config-amplifybackend.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-amplifybackend.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-amplifybackend.dev",
			clientEndpoint: aws.String("https://client-amplifybackend.dev"),
			expectURL:      aws.String("https://client-amplifybackend.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AMPLIFYBACKEND", c.envService)
			}
