...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workmailmessageflow.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workmailmessageflow.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workmailmessageflow.dev",
			expectURL:     aws.String("https://env-workmailmessageflow.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workmailmessageflow.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workmailmessageflow.dev",
			expectURL:     aws.String("http://config-workmailmessageflow.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workmailmessageflow.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workmailmessageflow.dev",
			clientEndpoint: aws.String("https://client-workmailmessageflow.dev"),
			expectURL:      aws.String("https://client-workmailmessageflow.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKMAILMESSAGEFLOW", c.envService)
			}
