...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-support.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-support.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-support.dev",
			expectURL:     aws.String("https://env-support.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-support.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-support.dev",
			expectURL:     aws.String("http://config-support.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-support.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-support.dev",
			clientEndpoint: aws.String("https://client-support.dev"),
			expectURL:      aws.String("https://client-support.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SUPPORT", c.envService)
			}
