...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codeguruprofiler.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguruprofiler.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguruprofiler.dev",
			expectURL:     aws.String("https://env-codeguruprofiler.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codeguruprofiler.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguruprofiler.dev",
			expectURL:     aws.String("http://config-codeguruprofiler.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codeguruprofiler.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codeguruprofiler.dev",
			clientEndpoint: aws.String("https://client-codeguruprofiler.dev"),
			expectURL:      aws.String("https://client-codeguruprofiler.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEGURUPROFILER", c.envService)
			}
