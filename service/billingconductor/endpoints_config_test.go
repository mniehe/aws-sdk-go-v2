...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-billingconductor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-billingconductor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-billingconductor.dev",
			expectURL:     aws.String("https://env-billingconductor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-billingconductor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-billingconductor.dev",
			expectURL:     aws.String("http://config-billingconductor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-billingconductor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-billingconductor.dev",
			clientEndpoint: aws.String("https://client-billingconductor.dev"),
			expectURL:      aws.String("https://client-billingconductor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BILLINGCONDUCTOR", c.envService)
			}
