...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-frauddetector.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-frauddetector.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-frauddetector.dev",
			expectURL:     aws.String("https://env-frauddetector.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-frauddetector.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-frauddetector.dev",
			expectURL:     aws.String("http://config-frauddetector.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-frauddetector.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-frauddetector.dev",
			clientEndpoint: aws.String("https://client-frauddetector.dev"),
			expectURL:      aws.String("https://client-frauddetector.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FRAUDDETECTOR", c.envService)
			}
