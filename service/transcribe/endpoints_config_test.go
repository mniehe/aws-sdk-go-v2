...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-transcribe.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transcribe.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transcribe.dev",
			expectURL:     aws.String("https://env-transcribe.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-transcribe.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transcribe.dev",
			expectURL:     aws.String("http://config-transcribe.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-transcribe.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-transcribe.dev",
			clientEndpoint: aws.String("https://client-transcribe.dev"),
			expectURL:      aws.String("https://client-transcribe.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TRANSCRIBE", c.envService)
			}
