...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-memorydb.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-memorydb.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-memorydb.dev",
			expectURL:     aws.String("https://env-memorydb.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-memorydb.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-memorydb.dev",
			expectURL:     aws.String("http://config-memorydb.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-memorydb.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-memorydb.dev",
			clientEndpoint: aws.String("https://client-memorydb.dev"),
			expectURL:      aws.String("https://client-memorydb.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEMORYDB", c.envService)
			}
