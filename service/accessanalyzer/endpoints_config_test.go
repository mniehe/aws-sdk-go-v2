...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-accessanalyzer.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-accessanalyzer.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-accessanalyzer.dev",
			expectURL:     aws.String("https://env-accessanalyzer.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-accessanalyzer.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-accessanalyzer.dev",
			expectURL:     aws.String("http://config-accessanalyzer.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-accessanalyzer.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-accessanalyzer.dev",
			clientEndpoint: aws.String("https://client-accessanalyzer.dev"),
			expectURL:      aws.String("https://client-accessanalyzer.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ACCESSANALYZER", c.envService)
			}
