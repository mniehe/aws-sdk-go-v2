...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-glacier.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-glacier.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-glacier.dev",
			expectURL:     aws.String("https://env-glacier.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-glacier.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-glacier.dev",
			expectURL:     aws.String("http://config-glacier.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-glacier.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-glacier.dev",
			clientEndpoint: aws.String("https://client-glacier.dev"),
			expectURL:      aws.String("https://client-glacier.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GLACIER", c.envService)
			}
