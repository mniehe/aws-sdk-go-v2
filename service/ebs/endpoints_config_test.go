...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ebs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ebs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ebs.dev",
			expectURL:     aws.String("https://env-ebs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ebs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ebs.dev",
			expectURL:     aws.String("http://config-ebs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ebs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ebs.dev",
			clientEndpoint: aws.String("https://client-ebs.dev"),
			expectURL:      aws.String("https://client-ebs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EBS", c.envService)
			}
