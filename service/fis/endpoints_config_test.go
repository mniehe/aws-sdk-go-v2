...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-fis.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fis.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fis.dev",
			expectURL:     aws.String("https://env-fis.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-fis.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fis.dev",
			expectURL:     aws.String("http://config-fis.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-fis.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-fis.dev",
			clientEndpoint: aws.String("https://client-fis.dev"),
			expectURL:      aws.String("https://client-fis.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FIS", c.envService)
			}
