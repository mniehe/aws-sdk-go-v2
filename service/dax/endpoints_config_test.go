...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-dax.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dax.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dax.dev",
			expectURL:     aws.String("https://env-dax.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-dax.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dax.dev",
			expectURL:     aws.String("http://config-dax.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-dax.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-dax.dev",
			clientEndpoint: aws.String("https://client-dax.dev"),
			expectURL:      aws.String("https://client-dax.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DAX", c.envService)
			}
