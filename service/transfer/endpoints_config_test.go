...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-transfer.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transfer.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transfer.dev",
			expectURL:     aws.String("https://env-transfer.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-transfer.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transfer.dev",
			expectURL:     aws.String("http://config-transfer.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-transfer.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-transfer.dev",
			clientEndpoint: aws.String("https://client-transfer.dev"),
			expectURL:      aws.String("https://client-transfer.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TRANSFER", c.envService)
			}
