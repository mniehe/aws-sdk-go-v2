...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mediaconnect.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediaconnect.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediaconnect.dev",
			expectURL:     aws.String("https://env-mediaconnect.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mediaconnect.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediaconnect.dev",
			expectURL:     aws.String("http://config-mediaconnect.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mediaconnect.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mediaconnect.dev",
			clientEndpoint: aws.String("https://client-mediaconnect.dev"),
			expectURL:      aws.String("https://client-mediaconnect.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIACONNECT", c.envService)
			}
