...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lightsail.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lightsail.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lightsail.dev",
			expectURL:     aws.String("https://env-lightsail.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lightsail.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lightsail.dev",
			expectURL:     aws.String("http://config-lightsail.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lightsail.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lightsail.dev",
			clientEndpoint: aws.String("https://client-lightsail.dev"),
			expectURL:      aws.String("https://client-lightsail.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LIGHTSAIL", c.envService)
			}
