...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lookoutvision.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutvision.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutvision.dev",
			expectURL:     aws.String("https://env-lookoutvision.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lookoutvision.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutvision.dev",
			expectURL:     aws.String("http://config-lookoutvision.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lookoutvision.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lookoutvision.dev",
			clientEndpoint: aws.String("https://client-lookoutvision.dev"),
			expectURL:      aws.String("https://client-lookoutvision.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LOOKOUTVISION", c.envService)
			}
