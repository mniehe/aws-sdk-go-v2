...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-securityhub.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securityhub.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securityhub.dev",
			expectURL:     aws.String("https://env-securityhub.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-securityhub.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securityhub.dev",
			expectURL:     aws.String("http://config-securityhub.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-securityhub.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-securityhub.dev",
			clientEndpoint: aws.String("https://client-securityhub.dev"),
			expectURL:      aws.String("https://client-securityhub.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SECURITYHUB", c.envService)
			}
