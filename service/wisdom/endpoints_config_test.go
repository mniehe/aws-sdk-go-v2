...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-wisdom.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-wisdom.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-wisdom.dev",
			expectURL:     aws.String("https://env-wisdom.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-wisdom.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-wisdom.dev",
			expectURL:     aws.String("http://config-wisdom.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-wisdom.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-wisdom.dev",
			clientEndpoint: aws.String("https://client-wisdom.dev"),
			expectURL:      aws.String("https://client-wisdom.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WISDOM", c.envService)
			}
