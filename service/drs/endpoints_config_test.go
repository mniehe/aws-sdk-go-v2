...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-drs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-drs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-drs.dev",
			expectURL:     aws.String("https://env-drs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-drs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-drs.dev",
			expectURL:     aws.String("http://config-drs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-drs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-drs.dev",
			clientEndpoint: aws.String("https://client-drs.dev"),
			expectURL:      aws.String("https://client-drs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DRS", c.envService)
			}
