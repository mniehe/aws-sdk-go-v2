...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iot-events-data.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-events-data.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-events-data.dev",
			expectURL:     aws.String("https://env-iot-events-data.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iot-events-data.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-events-data.dev",
			expectURL:     aws.String("http://config-iot-events-data.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iot-events-data.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iot-events-data.dev",
			clientEndpoint: aws.String("https://client-iot-events-data.dev"),
			expectURL:      aws.String("https://client-iot-events-data.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOT_EVENTS_DATA", c.envService)
			}
