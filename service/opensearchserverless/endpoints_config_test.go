...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-opensearchserverless.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opensearchserverless.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opensearchserverless.dev",
			expectURL:     aws.String("https://env-opensearchserverless.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-opensearchserverless.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opensearchserverless.dev",
			expectURL:     aws.String("http://config-opensearchserverless.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-opensearchserverless.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-opensearchserverless.dev",
			clientEndpoint: aws.String("https://client-opensearchserverless.dev"),
			expectURL:      aws.String("https://client-opensearchserverless.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OPENSEARCHSERVERLESS", c.envService)
			}
