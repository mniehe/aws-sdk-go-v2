...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-detective.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-detective.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-detective.dev",
			expectURL:     aws.String("https://env-detective.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-detective.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-detective.dev",
			expectURL:     aws.String("http://config-detective.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-detective.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-detective.dev",
			clientEndpoint: aws.String("https://client-detective.dev"),
			expectURL:      aws.String("https://client-detective.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DETECTIVE", c.envService)
			}
