...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codedeploy.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codedeploy.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codedeploy.dev",
			expectURL:     aws.String("https://env-codedeploy.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codedeploy.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codedeploy.dev",
			expectURL:     aws.String("http://config-codedeploy.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codedeploy.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codedeploy.dev",
			clientEndpoint: aws.String("https://client-codedeploy.dev"),
			expectURL:      aws.String("https://client-codedeploy.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEDEPLOY", c.envService)
			}
