...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-neptune-graph.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptune-graph.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptune-graph.dev",
			expectURL:     aws.String("https://env-neptune-graph.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-neptune-graph.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptune-graph.dev",
			expectURL:     aws.String("http://config-neptune-graph.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-neptune-graph.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-neptune-graph.dev",
			clientEndpoint: aws.String("https://client-neptune-graph.dev"),
			expectURL:      aws.String("https://client-neptune-graph.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NEPTUNE_GRAPH", c.envService)
			}
