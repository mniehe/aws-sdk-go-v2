...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-swf.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-swf.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-swf.dev",
			expectURL:     aws.String("https://env-swf.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-swf.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-swf.dev",
			expectURL:     aws.String("http://config-swf.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-swf.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-swf.dev",
			clientEndpoint: aws.String("https://client-swf.dev"),
			expectURL:      aws.String("https://client-swf.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SWF", c.envService)
			}
