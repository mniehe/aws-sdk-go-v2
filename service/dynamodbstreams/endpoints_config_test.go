...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-dynamodb-streams.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dynamodb-streams.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dynamodb-streams.dev",
			expectURL:     aws.String("https://env-dynamodb-streams.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-dynamodb-streams.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dynamodb-streams.dev",
			expectURL:     aws.String("http://config-dynamodb-streams.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-dynamodb-streams.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-dynamodb-streams.dev",
			clientEndpoint: aws.String("https://client-dynamodb-streams.dev"),
			expectURL:      aws.String("https://client-dynamodb-streams.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DYNAMODB_STREAMS", c.envService)
			}
