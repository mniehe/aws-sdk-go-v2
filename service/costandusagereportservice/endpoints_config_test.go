...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cost-and-usage-report-service.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-and-usage-report-service.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-and-usage-report-service.dev",
			expectURL:     aws.String("https://env-cost-and-usage-report-service.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cost-and-usage-report-service.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cost-and-usage-report-service.dev",
			expectURL:     aws.String("http://config-cost-and-usage-report-service.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cost-and-usage-report-service.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cost-and-usage-report-service.dev",
			clientEndpoint: aws.String("https://client-cost-and-usage-report-service.dev"),
			expectURL:      aws.String("https://client-cost-and-usage-report-service.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COST_AND_USAGE_REPORT_SERVICE", c.envService)
			}
