...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workdocs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workdocs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workdocs.dev",
			expectURL:     aws.String("https://env-workdocs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workdocs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workdocs.dev",
			expectURL:     aws.String("http://config-workdocs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workdocs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workdocs.dev",
			clientEndpoint: aws.String("https://client-workdocs.dev"),
			expectURL:      aws.String("https://client-workdocs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKDOCS", c.envService)
			}
