...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-schemas.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-schemas.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-schemas.dev",
			expectURL:     aws.String("https://env-schemas.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-schemas.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-schemas.dev",
			expectURL:     aws.String("http://config-schemas.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-schemas.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-schemas.dev",
			clientEndpoint: aws.String("https://client-schemas.dev"),
			expectURL:      aws.String("https://client-schemas.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SCHEMAS", c.envService)
			}
