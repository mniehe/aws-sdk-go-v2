...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-controltower.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-controltower.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-controltower.dev",
			expectURL:     aws.String("https://env-controltower.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-controltower.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-controltower.dev",
			expectURL:     aws.String("http://config-controltower.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-controltower.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-controltower.dev",
			clientEndpoint: aws.String("https://client-controltower.dev"),
			expectURL:      aws.String("https://client-controltower.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONTROLTOWER", c.envService)
			}
