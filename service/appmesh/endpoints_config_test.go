...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-app-mesh.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-app-mesh.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-app-mesh.dev",
			expectURL:     aws.String("https://env-app-mesh.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-app-mesh.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-app-mesh.dev",
			expectURL:     aws.String("http://config-app-mesh.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-app-mesh.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-app-mesh.dev",
			clientEndpoint: aws.String("https://client-app-mesh.dev"),
			expectURL:      aws.String("https://client-app-mesh.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APP_MESH", c.envService)
			}
