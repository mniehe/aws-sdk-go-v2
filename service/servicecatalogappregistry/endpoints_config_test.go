...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-service-catalog-appregistry.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-catalog-appregistry.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-catalog-appregistry.dev",
			expectURL:     aws.String("https://env-service-catalog-appregistry.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-service-catalog-appregistry.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-catalog-appregistry.dev",
			expectURL:     aws.String("http://config-service-catalog-appregistry.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-service-catalog-appregistry.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-service-catalog-appregistry.dev",
			clientEndpoint: aws.String("https://client-service-catalog-appregistry.dev"),
			expectURL:      aws.String("https://client-service-catalog-appregistry.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SERVICE_CATALOG_APPREGISTRY", c.envService)
			}
