...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-opsworkscm.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opsworkscm.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opsworkscm.dev",
			expectURL:     aws.String("https://env-opsworkscm.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-opsworkscm.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opsworkscm.dev",
			expectURL:     aws.String("http://config-opsworkscm.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-opsworkscm.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-opsworkscm.dev",
			clientEndpoint: aws.String("https://client-opsworkscm.dev"),
			expectURL:      aws.String("https://client-opsworkscm.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OPSWORKSCM", c.envService)
			}
