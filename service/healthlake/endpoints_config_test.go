...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-healthlake.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-healthlake.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-healthlake.dev",
			expectURL:     aws.String("https://env-healthlake.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-healthlake.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-healthlake.dev",
			expectURL:     aws.String("http://config-healthlake.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-healthlake.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-healthlake.dev",
			clientEndpoint: aws.String("https://client-healthlake.dev"),
			expectURL:      aws.String("https://client-healthlake.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_HEALTHLAKE", c.envService)
			}
