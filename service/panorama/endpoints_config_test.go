...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-panorama.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-panorama.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-panorama.dev",
			expectURL:     aws.String("https://env-panorama.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-panorama.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-panorama.dev",
			expectURL:     aws.String("http://config-panorama.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-panorama.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-panorama.dev",
			clientEndpoint: aws.String("https://client-panorama.dev"),
			expectURL:      aws.String("https://client-panorama.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PANORAMA", c.envService)
			}
