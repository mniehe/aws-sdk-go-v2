...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appstream.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appstream.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appstream.dev",
			expectURL:     aws.String("https://env-appstream.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appstream.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appstream.dev",
			expectURL:     aws.String("http://config-appstream.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appstream.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appstream.dev",
			clientEndpoint: aws.String("https://client-appstream.dev"),
			expectURL:      aws.String("https://client-appstream.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPSTREAM", c.envService)
			}
