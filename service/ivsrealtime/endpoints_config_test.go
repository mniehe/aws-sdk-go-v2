...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ivs-realtime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivs-realtime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivs-realtime.dev",
			expectURL:     aws.String("https://env-ivs-realtime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ivs-realtime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivs-realtime.dev",
			expectURL:     aws.String("http://config-ivs-realtime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ivs-realtime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ivs-realtime.dev",
			clientEndpoint: aws.String("https://client-ivs-realtime.dev"),
			expectURL:      aws.String("https://client-ivs-realtime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IVS_REALTIME", c.envService)
			}
