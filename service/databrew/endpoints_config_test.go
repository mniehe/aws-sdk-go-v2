...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-databrew.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-databrew.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-databrew.dev",
			expectURL:     aws.String("https://env-databrew.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-databrew.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-databrew.dev",
			expectURL:     aws.String("http://config-databrew.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-databrew.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-databrew.dev",
			clientEndpoint: aws.String("https://client-databrew.dev"),
			expectURL:      aws.String("https://client-databrew.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DATABREW", c.envService)
			}
