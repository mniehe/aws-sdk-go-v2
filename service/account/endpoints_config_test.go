...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-account.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-account.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-account.dev",
			expectURL:     aws.String("https://env-account.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-account.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-account.dev",
			expectURL:     aws.String("http://config-account.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-account.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-account.dev",
			clientEndpoint: aws.String("https://client-account.dev"),
			expectURL:      aws.String("https://client-account.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ACCOUNT", c.envService)
			}
