...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-fms.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fms.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fms.dev",
			expectURL:     aws.String("https://env-fms.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-fms.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fms.dev",
			expectURL:     aws.String("http://config-fms.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-fms.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-fms.dev",
			clientEndpoint: aws.String("https://client-fms.dev"),
			expectURL:      aws.String("https://client-fms.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FMS", c.envService)
			}
