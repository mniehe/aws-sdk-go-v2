...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-backupstorage.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-backupstorage.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-backupstorage.dev",
			expectURL:     aws.String("https://env-backupstorage.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-backupstorage.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-backupstorage.dev",
			expectURL:     aws.String("http://config-backupstorage.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-backupstorage.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-backupstorage.dev",
			clientEndpoint: aws.String("https://client-backupstorage.dev"),
			expectURL:      aws.String("https://client-backupstorage.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BACKUPSTORAGE", c.envService)
			}
