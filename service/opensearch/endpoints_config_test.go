...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-opensearch.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opensearch.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opensearch.dev",
			expectURL:     aws.String("https://env-opensearch.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-opensearch.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opensearch.dev",
			expectURL:     aws.String("http://config-opensearch.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-opensearch.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-opensearch.dev",
			clientEndpoint: aws.String("https://client-opensearch.dev"),
			expectURL:      aws.String("https://client-opensearch.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OPENSEARCH", c.envService)
			}
