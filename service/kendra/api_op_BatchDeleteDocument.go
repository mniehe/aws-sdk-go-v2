...
// Amazon Web Services CloudWatch log. You can also use the BatchGetDocumentStatus
// API to monitor the progress of deleting your documents. Deleting documents from
// an index using BatchDeleteDocument could take up to an hour or more, depending
