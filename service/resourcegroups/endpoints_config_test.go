...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-resource-groups.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resource-groups.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resource-groups.dev",
			expectURL:     aws.String("https://env-resource-groups.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-resource-groups.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resource-groups.dev",
			expectURL:     aws.String("http://config-resource-groups.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-resource-groups.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-resource-groups.dev",
			clientEndpoint: aws.String("https://client-resource-groups.dev"),
			expectURL:      aws.String("https://client-resource-groups.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RESOURCE_GROUPS", c.envService)
			}
