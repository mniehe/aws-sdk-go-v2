...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-alexa-for-business.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-alexa-for-business.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-alexa-for-business.dev",
			expectURL:     aws.String("https://env-alexa-for-business.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-alexa-for-business.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-alexa-for-business.dev",
			expectURL:     aws.String("http://config-alexa-for-business.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-alexa-for-business.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-alexa-for-business.dev",
			clientEndpoint: aws.String("https://client-alexa-for-business.dev"),
			expectURL:      aws.String("https://client-alexa-for-business.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ALEXA_FOR_BUSINESS", c.envService)
			}
