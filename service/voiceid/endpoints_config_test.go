...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-voice-id.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-voice-id.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-voice-id.dev",
			expectURL:     aws.String("https://env-voice-id.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-voice-id.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-voice-id.dev",
			expectURL:     aws.String("http://config-voice-id.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-voice-id.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-voice-id.dev",
			clientEndpoint: aws.String("https://client-voice-id.dev"),
			expectURL:      aws.String("https://client-voice-id.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_VOICE_ID", c.envService)
			}
