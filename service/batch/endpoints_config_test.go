...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-batch.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-batch.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-batch.dev",
			expectURL:     aws.String("https://env-batch.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-batch.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-batch.dev",
			expectURL:     aws.String("http://config-batch.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-batch.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-batch.dev",
			clientEndpoint: aws.String("https://client-batch.dev"),
			expectURL:      aws.String("https://client-batch.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BATCH", c.envService)
			}
