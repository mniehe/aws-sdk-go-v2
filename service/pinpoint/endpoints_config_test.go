...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pinpoint.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint.dev",
			expectURL:     aws.String("https://env-pinpoint.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pinpoint.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint.dev",
			expectURL:     aws.String("http://config-pinpoint.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pinpoint.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pinpoint.dev",
			clientEndpoint: aws.String("https://client-pinpoint.dev"),
			expectURL:      aws.String("https://client-pinpoint.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PINPOINT", c.envService)
			}
