...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ivs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivs.dev",
			expectURL:     aws.String("https://env-ivs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ivs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivs.dev",
			expectURL:     aws.String("http://config-ivs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ivs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ivs.dev",
			clientEndpoint: aws.String("https://client-ivs.dev"),
			expectURL:      aws.String("https://client-ivs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IVS", c.envService)
			}
