...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-personalize.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize.dev",
			expectURL:     aws.String("https://env-personalize.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-personalize.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize.dev",
			expectURL:     aws.String("http://config-personalize.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-personalize.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-personalize.dev",
			clientEndpoint: aws.String("https://client-personalize.dev"),
			expectURL:      aws.String("https://client-personalize.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PERSONALIZE", c.envService)
			}
