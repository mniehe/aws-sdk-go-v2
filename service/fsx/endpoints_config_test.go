...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-fsx.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fsx.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fsx.dev",
			expectURL:     aws.String("https://env-fsx.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-fsx.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-fsx.dev",
			expectURL:     aws.String("http://config-fsx.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-fsx.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-fsx.dev",
			clientEndpoint: aws.String("https://client-fsx.dev"),
			expectURL:      aws.String("https://client-fsx.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FSX", c.envService)
			}
