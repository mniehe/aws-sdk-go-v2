...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotsitewise.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotsitewise.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotsitewise.dev",
			expectURL:     aws.String("https://env-iotsitewise.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotsitewise.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotsitewise.dev",
			expectURL:     aws.String("http://config-iotsitewise.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotsitewise.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotsitewise.dev",
			clientEndpoint: aws.String("https://client-iotsitewise.dev"),
			expectURL:      aws.String("https://client-iotsitewise.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTSITEWISE", c.envService)
			}
