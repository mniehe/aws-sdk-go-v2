...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sns.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sns.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sns.dev",
			expectURL:     aws.String("https://env-sns.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sns.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sns.dev",
			expectURL:     aws.String("http://config-sns.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sns.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sns.dev",
			clientEndpoint: aws.String("https://client-sns.dev"),
			expectURL:      aws.String("https://client-sns.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SNS", c.envService)
			}
