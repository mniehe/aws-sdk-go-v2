...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-acm-pca.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-acm-pca.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-acm-pca.dev",
			expectURL:     aws.String("https://env-acm-pca.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-acm-pca.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-acm-pca.dev",
			expectURL:     aws.String("http://config-acm-pca.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-acm-pca.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-acm-pca.dev",
			clientEndpoint: aws.String("https://client-acm-pca.dev"),
			expectURL:      aws.String("https://client-acm-pca.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ACM_PCA", c.envService)
			}
