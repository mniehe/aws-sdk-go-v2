...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ec2-instance-connect.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ec2-instance-connect.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ec2-instance-connect.dev",
			expectURL:     aws.String("https://env-ec2-instance-connect.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ec2-instance-connect.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ec2-instance-connect.dev",
			expectURL:     aws.String("http://config-ec2-instance-connect.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ec2-instance-connect.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ec2-instance-connect.dev",
			clientEndpoint: aws.String("https://client-ec2-instance-connect.dev"),
			expectURL:      aws.String("https://client-ec2-instance-connect.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EC2_INSTANCE_CONNECT", c.envService)
			}
