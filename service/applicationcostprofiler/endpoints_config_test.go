...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-applicationcostprofiler.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-applicationcostprofiler.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-applicationcostprofiler.dev",
			expectURL:     aws.String("https://env-applicationcostprofiler.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-applicationcostprofiler.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-applicationcostprofiler.dev",
			expectURL:     aws.String("http://config-applicationcostprofiler.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-applicationcostprofiler.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-applicationcostprofiler.dev",
			clientEndpoint: aws.String("https://client-applicationcostprofiler.dev"),
			expectURL:      aws.String("https://client-applicationcostprofiler.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPLICATIONCOSTPROFILER", c.envService)
			}
