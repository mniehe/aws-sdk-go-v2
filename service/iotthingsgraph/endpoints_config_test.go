...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotthingsgraph.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotthingsgraph.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotthingsgraph.dev",
			expectURL:     aws.String("https://env-iotthingsgraph.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotthingsgraph.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotthingsgraph.dev",
			expectURL:     aws.String("http://config-iotthingsgraph.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotthingsgraph.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotthingsgraph.dev",
			clientEndpoint: aws.String("https://client-iotthingsgraph.dev"),
			expectURL:      aws.String("https://client-iotthingsgraph.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTTHINGSGRAPH", c.envService)
			}
