...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-global-accelerator.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-global-accelerator.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-global-accelerator.dev",
			expectURL:     aws.String("https://env-global-accelerator.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-global-accelerator.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-global-accelerator.dev",
			expectURL:     aws.String("http://config-global-accelerator.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-global-accelerator.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-global-accelerator.dev",
			clientEndpoint: aws.String("https://client-global-accelerator.dev"),
			expectURL:      aws.String("https://client-global-accelerator.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GLOBAL_ACCELERATOR", c.envService)
			}
