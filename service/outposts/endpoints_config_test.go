...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-outposts.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-outposts.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-outposts.dev",
			expectURL:     aws.String("https://env-outposts.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-outposts.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-outposts.dev",
			expectURL:     aws.String("http://config-outposts.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-outposts.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-outposts.dev",
			clientEndpoint: aws.String("https://client-outposts.dev"),
			expectURL:      aws.String("https://client-outposts.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OUTPOSTS", c.envService)
			}
