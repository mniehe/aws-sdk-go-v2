...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-managedblockchain-query.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-managedblockchain-query.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-managedblockchain-query.dev",
			expectURL:     aws.String("https://env-managedblockchain-query.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-managedblockchain-query.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-managedblockchain-query.dev",
			expectURL:     aws.String("http://config-managedblockchain-query.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-managedblockchain-query.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-managedblockchain-query.dev",
			clientEndpoint: aws.String("https://client-managedblockchain-query.dev"),
			expectURL:      aws.String("https://client-managedblockchain-query.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MANAGEDBLOCKCHAIN_QUERY", c.envService)
			}
