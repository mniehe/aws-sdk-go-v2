...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-chime-sdk-media-pipelines.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-media-pipelines.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-media-pipelines.dev",
			expectURL:     aws.String("https://env-chime-sdk-media-pipelines.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-chime-sdk-media-pipelines.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-media-pipelines.dev",
			expectURL:     aws.String("http://config-chime-sdk-media-pipelines.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-chime-sdk-media-pipelines.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-chime-sdk-media-pipelines.dev",
			clientEndpoint: aws.String("https://client-chime-sdk-media-pipelines.dev"),
			expectURL:      aws.String("https://client-chime-sdk-media-pipelines.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CHIME_SDK_MEDIA_PIPELINES", c.envService)
			}
