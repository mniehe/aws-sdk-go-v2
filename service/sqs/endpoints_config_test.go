...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sqs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sqs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sqs.dev",
			expectURL:     aws.String("https://env-sqs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sqs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sqs.dev",
			expectURL:     aws.String("http://config-sqs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sqs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sqs.dev",
			clientEndpoint: aws.String("https://client-sqs.dev"),
			expectURL:      aws.String("https://client-sqs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SQS", c.envService)
			}
