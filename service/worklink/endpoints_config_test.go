...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-worklink.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-worklink.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-worklink.dev",
			expectURL:     aws.String("https://env-worklink.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-worklink.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-worklink.dev",
			expectURL:     aws.String("http://config-worklink.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-worklink.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-worklink.dev",
			clientEndpoint: aws.String("https://client-worklink.dev"),
			expectURL:      aws.String("https://client-worklink.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKLINK", c.envService)
			}
