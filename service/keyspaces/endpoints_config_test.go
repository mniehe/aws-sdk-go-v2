...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-keyspaces.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-keyspaces.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-keyspaces.dev",
			expectURL:     aws.String("https://env-keyspaces.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-keyspaces.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-keyspaces.dev",
			expectURL:     aws.String("http://config-keyspaces.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-keyspaces.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-keyspaces.dev",
			clientEndpoint: aws.String("https://client-keyspaces.dev"),
			expectURL:      aws.String("https://client-keyspaces.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KEYSPACES", c.envService)
			}
