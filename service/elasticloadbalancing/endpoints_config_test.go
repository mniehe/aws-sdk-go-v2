...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-elastic-load-balancing.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-load-balancing.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-load-balancing.dev",
			expectURL:     aws.String("https://env-elastic-load-balancing.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-elastic-load-balancing.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-load-balancing.dev",
			expectURL:     aws.String("http://config-elastic-load-balancing.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-elastic-load-balancing.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-elastic-load-balancing.dev",
			clientEndpoint: aws.String("https://client-elastic-load-balancing.dev"),
			expectURL:      aws.String("https://client-elastic-load-balancing.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ELASTIC_LOAD_BALANCING", c.envService)
			}
