...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lex-model-building-service.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lex-model-building-service.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lex-model-building-service.dev",
			expectURL:     aws.String("https://env-lex-model-building-service.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lex-model-building-service.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lex-model-building-service.dev",
			expectURL:     aws.String("http://config-lex-model-building-service.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lex-model-building-service.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lex-model-building-service.dev",
			clientEndpoint: aws.String("https://client-lex-model-building-service.dev"),
			expectURL:      aws.String("https://client-lex-model-building-service.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LEX_MODEL_BUILDING_SERVICE", c.envService)
			}
