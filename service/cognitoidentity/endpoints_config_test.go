...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cognito-identity.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cognito-identity.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cognito-identity.dev",
			expectURL:     aws.String("https://env-cognito-identity.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cognito-identity.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cognito-identity.dev",
			expectURL:     aws.String("http://config-cognito-identity.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cognito-identity.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cognito-identity.dev",
			clientEndpoint: aws.String("https://client-cognito-identity.dev"),
			expectURL:      aws.String("https://client-cognito-identity.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COGNITO_IDENTITY", c.envService)
			}
