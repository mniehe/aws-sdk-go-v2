...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-amplifyuibuilder.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplifyuibuilder.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplifyuibuilder.dev",
			expectURL:     aws.String("https://env-amplifyuibuilder.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-amplifyuibuilder.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amplifyuibuilder.dev",
			expectURL:     aws.String("http://config-amplifyuibuilder.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-amplifyuibuilder.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-amplifyuibuilder.dev",
			clientEndpoint: aws.String("https://client-amplifyuibuilder.dev"),
			expectURL:      aws.String("https://client-amplifyuibuilder.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AMPLIFYUIBUILDER", c.envService)
			}
