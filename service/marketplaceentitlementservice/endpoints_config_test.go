...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-marketplace-entitlement-service.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-entitlement-service.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-entitlement-service.dev",
			expectURL:     aws.String("https://env-marketplace-entitlement-service.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-marketplace-entitlement-service.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-entitlement-service.dev",
			expectURL:     aws.String("http://config-marketplace-entitlement-service.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-marketplace-entitlement-service.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-marketplace-entitlement-service.dev",
			clientEndpoint: aws.String("https://client-marketplace-entitlement-service.dev"),
			expectURL:      aws.String("https://client-marketplace-entitlement-service.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MARKETPLACE_ENTITLEMENT_SERVICE", c.envService)
			}
