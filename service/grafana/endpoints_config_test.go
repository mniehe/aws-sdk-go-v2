...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-grafana.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-grafana.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-grafana.dev",
			expectURL:     aws.String("https://env-grafana.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-grafana.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-grafana.dev",
			expectURL:     aws.String("http://config-grafana.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-grafana.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-grafana.dev",
			clientEndpoint: aws.String("https://client-grafana.dev"),
			expectURL:      aws.String("https://client-grafana.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GRAFANA", c.envService)
			}
