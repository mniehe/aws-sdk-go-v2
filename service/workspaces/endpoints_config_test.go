...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workspaces.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces.dev",
			expectURL:     aws.String("https://env-workspaces.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workspaces.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces.dev",
			expectURL:     aws.String("http://config-workspaces.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workspaces.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workspaces.dev",
			clientEndpoint: aws.String("https://client-workspaces.dev"),
			expectURL:      aws.String("https://client-workspaces.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKSPACES", c.envService)
			}
