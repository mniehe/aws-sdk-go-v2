...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mediastore-data.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediastore-data.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediastore-data.dev",
			expectURL:     aws.String("https://env-mediastore-data.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mediastore-data.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediastore-data.dev",
			expectURL:     aws.String("http://config-mediastore-data.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mediastore-data.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mediastore-data.dev",
			clientEndpoint: aws.String("https://client-mediastore-data.dev"),
			expectURL:      aws.String("https://client-mediastore-data.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIASTORE_DATA", c.envService)
			}
