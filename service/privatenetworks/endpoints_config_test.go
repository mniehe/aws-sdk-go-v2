...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-privatenetworks.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-privatenetworks.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-privatenetworks.dev",
			expectURL:     aws.String("https://env-privatenetworks.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-privatenetworks.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-privatenetworks.dev",
			expectURL:     aws.String("http://config-privatenetworks.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-privatenetworks.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-privatenetworks.dev",
			clientEndpoint: aws.String("https://client-privatenetworks.dev"),
			expectURL:      aws.String("https://client-privatenetworks.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PRIVATENETWORKS", c.envService)
			}
