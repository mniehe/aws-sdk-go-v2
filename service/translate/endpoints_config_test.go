...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-translate.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-translate.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-translate.dev",
			expectURL:     aws.String("https://env-translate.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-translate.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-translate.dev",
			expectURL:     aws.String("http://config-translate.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-translate.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-translate.dev",
			clientEndpoint: aws.String("https://client-translate.dev"),
			expectURL:      aws.String("https://client-translate.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TRANSLATE", c.envService)
			}
