...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appconfigdata.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appconfigdata.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appconfigdata.dev",
			expectURL:     aws.String("https://env-appconfigdata.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appconfigdata.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appconfigdata.dev",
			expectURL:     aws.String("http://config-appconfigdata.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appconfigdata.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appconfigdata.dev",
			clientEndpoint: aws.String("https://client-appconfigdata.dev"),
			expectURL:      aws.String("https://client-appconfigdata.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPCONFIGDATA", c.envService)
			}
