...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-personalize-runtime.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize-runtime.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize-runtime.dev",
			expectURL:     aws.String("https://env-personalize-runtime.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-personalize-runtime.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize-runtime.dev",
			expectURL:     aws.String("http://config-personalize-runtime.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-personalize-runtime.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-personalize-runtime.dev",
			clientEndpoint: aws.String("https://client-personalize-runtime.dev"),
			expectURL:      aws.String("https://client-personalize-runtime.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PERSONALIZE_RUNTIME", c.envService)
			}
