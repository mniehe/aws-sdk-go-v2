...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mobile.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mobile.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mobile.dev",
			expectURL:     aws.String("https://env-mobile.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mobile.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mobile.dev",
			expectURL:     aws.String("http://config-mobile.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mobile.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mobile.dev",
			clientEndpoint: aws.String("https://client-mobile.dev"),
			expectURL:      aws.String("https://client-mobile.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MOBILE", c.envService)
			}
