...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-marketplace-commerce-analytics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-commerce-analytics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-commerce-analytics.dev",
			expectURL:     aws.String("https://env-marketplace-commerce-analytics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-marketplace-commerce-analytics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-commerce-analytics.dev",
			expectURL:     aws.String("http://config-marketplace-commerce-analytics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-marketplace-commerce-analytics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-marketplace-commerce-analytics.dev",
			clientEndpoint: aws.String("https://client-marketplace-commerce-analytics.dev"),
			expectURL:      aws.String("https://client-marketplace-commerce-analytics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MARKETPLACE_COMMERCE_ANALYTICS", c.envService)
			}
