...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rolesanywhere.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rolesanywhere.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rolesanywhere.dev",
			expectURL:     aws.String("https://env-rolesanywhere.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rolesanywhere.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rolesanywhere.dev",
			expectURL:     aws.String("http://config-rolesanywhere.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rolesanywhere.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rolesanywhere.dev",
			clientEndpoint: aws.String("https://client-rolesanywhere.dev"),
			expectURL:      aws.String("https://client-rolesanywhere.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ROLESANYWHERE", c.envService)
			}
