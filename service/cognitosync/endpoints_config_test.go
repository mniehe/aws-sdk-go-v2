...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cognito-sync.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cognito-sync.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cognito-sync.dev",
			expectURL:     aws.String("https://env-cognito-sync.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cognito-sync.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cognito-sync.dev",
			expectURL:     aws.String("http://config-cognito-sync.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cognito-sync.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cognito-sync.dev",
			clientEndpoint: aws.String("https://client-cognito-sync.dev"),
			expectURL:      aws.String("https://client-cognito-sync.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COGNITO_SYNC", c.envService)
			}
