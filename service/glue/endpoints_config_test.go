...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-glue.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-glue.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-glue.dev",
			expectURL:     aws.String("https://env-glue.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-glue.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-glue.dev",
			expectURL:     aws.String("http://config-glue.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-glue.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-glue.dev",
			clientEndpoint: aws.String("https://client-glue.dev"),
			expectURL:      aws.String("https://client-glue.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GLUE", c.envService)
			}
