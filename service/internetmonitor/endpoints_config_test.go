...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-internetmonitor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-internetmonitor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-internetmonitor.dev",
			expectURL:     aws.String("https://env-internetmonitor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-internetmonitor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-internetmonitor.dev",
			expectURL:     aws.String("http://config-internetmonitor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-internetmonitor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-internetmonitor.dev",
			clientEndpoint: aws.String("https://client-internetmonitor.dev"),
			expectURL:      aws.String("https://client-internetmonitor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_INTERNETMONITOR", c.envService)
			}
