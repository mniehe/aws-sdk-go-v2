...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-honeycode.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-honeycode.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-honeycode.dev",
			expectURL:     aws.String("https://env-honeycode.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-honeycode.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-honeycode.dev",
			expectURL:     aws.String("http://config-honeycode.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-honeycode.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-honeycode.dev",
			clientEndpoint: aws.String("https://client-honeycode.dev"),
			expectURL:      aws.String("https://client-honeycode.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_HONEYCODE", c.envService)
			}
