...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-osis.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-osis.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-osis.dev",
			expectURL:     aws.String("https://env-osis.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-osis.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-osis.dev",
			expectURL:     aws.String("http://config-osis.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-osis.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-osis.dev",
			clientEndpoint: aws.String("https://client-osis.dev"),
			expectURL:      aws.String("https://client-osis.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OSIS", c.envService)
			}
