...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-efs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-efs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-efs.dev",
			expectURL:     aws.String("https://env-efs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-efs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-efs.dev",
			expectURL:     aws.String("http://config-efs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-efs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-efs.dev",
			clientEndpoint: aws.String("https://client-efs.dev"),
			expectURL:      aws.String("https://client-efs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EFS", c.envService)
			}
