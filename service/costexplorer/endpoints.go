...
import (
	...
	internalendpoints "github.com/mniehe/aws-sdk-go-v2/service/costexplorer/internal/endpoints"
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == false {
					if _UseDualStack == false {
						uriString := "https://ce.us-east-1.amazonaws.com"
			...
			if _PartitionResult.Name == "aws-cn" {
				if _UseFIPS == false {
					if _UseDualStack == false {
						uriString := "https://ce.cn-northwest-1.amazonaws.com.cn"
