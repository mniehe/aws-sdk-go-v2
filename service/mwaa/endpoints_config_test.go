...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mwaa.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mwaa.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mwaa.dev",
			expectURL:     aws.String("https://env-mwaa.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mwaa.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mwaa.dev",
			expectURL:     aws.String("http://config-mwaa.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mwaa.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mwaa.dev",
			clientEndpoint: aws.String("https://client-mwaa.dev"),
			expectURL:      aws.String("https://client-mwaa.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MWAA", c.envService)
			}
