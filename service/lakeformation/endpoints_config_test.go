...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lakeformation.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lakeformation.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lakeformation.dev",
			expectURL:     aws.String("https://env-lakeformation.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lakeformation.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lakeformation.dev",
			expectURL:     aws.String("http://config-lakeformation.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lakeformation.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lakeformation.dev",
			clientEndpoint: aws.String("https://client-lakeformation.dev"),
			expectURL:      aws.String("https://client-lakeformation.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LAKEFORMATION", c.envService)
			}
