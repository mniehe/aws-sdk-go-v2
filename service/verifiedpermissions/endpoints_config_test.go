...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-verifiedpermissions.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-verifiedpermissions.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-verifiedpermissions.dev",
			expectURL:     aws.String("https://env-verifiedpermissions.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-verifiedpermissions.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-verifiedpermissions.dev",
			expectURL:     aws.String("http://config-verifiedpermissions.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-verifiedpermissions.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-verifiedpermissions.dev",
			clientEndpoint: aws.String("https://client-verifiedpermissions.dev"),
			expectURL:      aws.String("https://client-verifiedpermissions.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_VERIFIEDPERMISSIONS", c.envService)
			}
