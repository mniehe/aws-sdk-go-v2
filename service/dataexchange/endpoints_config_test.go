...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-dataexchange.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dataexchange.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dataexchange.dev",
			expectURL:     aws.String("https://env-dataexchange.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-dataexchange.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-dataexchange.dev",
			expectURL:     aws.String("http://config-dataexchange.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-dataexchange.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-dataexchange.dev",
			clientEndpoint: aws.String("https://client-dataexchange.dev"),
			expectURL:      aws.String("https://client-dataexchange.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DATAEXCHANGE", c.envService)
			}
