...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-synthetics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-synthetics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-synthetics.dev",
			expectURL:     aws.String("https://env-synthetics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-synthetics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-synthetics.dev",
			expectURL:     aws.String("http://config-synthetics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-synthetics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-synthetics.dev",
			clientEndpoint: aws.String("https://client-synthetics.dev"),
			expectURL:      aws.String("https://client-synthetics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SYNTHETICS", c.envService)
			}
