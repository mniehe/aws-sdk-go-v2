...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-api-gateway.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-api-gateway.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-api-gateway.dev",
			expectURL:     aws.String("https://env-api-gateway.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-api-gateway.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-api-gateway.dev",
			expectURL:     aws.String("http://config-api-gateway.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-api-gateway.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-api-gateway.dev",
			clientEndpoint: aws.String("https://client-api-gateway.dev"),
			expectURL:      aws.String("https://client-api-gateway.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_API_GATEWAY", c.envService)
			}
