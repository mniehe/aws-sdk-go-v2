...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-forecast.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-forecast.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-forecast.dev",
			expectURL:     aws.String("https://env-forecast.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-forecast.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-forecast.dev",
			expectURL:     aws.String("http://config-forecast.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-forecast.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-forecast.dev",
			clientEndpoint: aws.String("https://client-forecast.dev"),
			expectURL:      aws.String("https://client-forecast.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FORECAST", c.envService)
			}
