...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-connect-contact-lens.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connect-contact-lens.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connect-contact-lens.dev",
			expectURL:     aws.String("https://env-connect-contact-lens.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-connect-contact-lens.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connect-contact-lens.dev",
			expectURL:     aws.String("http://config-connect-contact-lens.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-connect-contact-lens.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-connect-contact-lens.dev",
			clientEndpoint: aws.String("https://client-connect-contact-lens.dev"),
			expectURL:      aws.String("https://client-connect-contact-lens.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONNECT_CONTACT_LENS", c.envService)
			}
