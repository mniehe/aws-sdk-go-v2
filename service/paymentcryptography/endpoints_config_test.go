...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-payment-cryptography.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-payment-cryptography.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-payment-cryptography.dev",
			expectURL:     aws.String("https://env-payment-cryptography.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-payment-cryptography.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-payment-cryptography.dev",
			expectURL:     aws.String("http://config-payment-cryptography.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-payment-cryptography.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-payment-cryptography.dev",
			clientEndpoint: aws.String("https://client-payment-cryptography.dev"),
			expectURL:      aws.String("https://client-payment-cryptography.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PAYMENT_CRYPTOGRAPHY", c.envService)
			}
