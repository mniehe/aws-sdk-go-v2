...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-marketplace-metering.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-metering.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-metering.dev",
			expectURL:     aws.String("https://env-marketplace-metering.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-marketplace-metering.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-marketplace-metering.dev",
			expectURL:     aws.String("http://config-marketplace-metering.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-marketplace-metering.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-marketplace-metering.dev",
			clientEndpoint: aws.String("https://client-marketplace-metering.dev"),
			expectURL:      aws.String("https://client-marketplace-metering.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MARKETPLACE_METERING", c.envService)
			}
