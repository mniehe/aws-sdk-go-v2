...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudtrail-data.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudtrail-data.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudtrail-data.dev",
			expectURL:     aws.String("https://env-cloudtrail-data.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudtrail-data.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudtrail-data.dev",
			expectURL:     aws.String("http://config-cloudtrail-data.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudtrail-data.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudtrail-data.dev",
			clientEndpoint: aws.String("https://client-cloudtrail-data.dev"),
			expectURL:      aws.String("https://client-cloudtrail-data.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDTRAIL_DATA", c.envService)
			}
