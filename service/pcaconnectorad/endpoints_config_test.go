...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pca-connector-ad.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pca-connector-ad.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pca-connector-ad.dev",
			expectURL:     aws.String("https://env-pca-connector-ad.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pca-connector-ad.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pca-connector-ad.dev",
			expectURL:     aws.String("http://config-pca-connector-ad.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pca-connector-ad.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pca-connector-ad.dev",
			clientEndpoint: aws.String("https://client-pca-connector-ad.dev"),
			expectURL:      aws.String("https://client-pca-connector-ad.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PCA_CONNECTOR_AD", c.envService)
			}
