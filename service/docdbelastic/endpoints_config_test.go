...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-docdb-elastic.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-docdb-elastic.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-docdb-elastic.dev",
			expectURL:     aws.String("https://env-docdb-elastic.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-docdb-elastic.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-docdb-elastic.dev",
			expectURL:     aws.String("http://config-docdb-elastic.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-docdb-elastic.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-docdb-elastic.dev",
			clientEndpoint: aws.String("https://client-docdb-elastic.dev"),
			expectURL:      aws.String("https://client-docdb-elastic.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DOCDB_ELASTIC", c.envService)
			}
