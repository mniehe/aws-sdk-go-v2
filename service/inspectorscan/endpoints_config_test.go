...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-inspector-scan.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-inspector-scan.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-inspector-scan.dev",
			expectURL:     aws.String("https://env-inspector-scan.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-inspector-scan.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-inspector-scan.dev",
			expectURL:     aws.String("http://config-inspector-scan.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-inspector-scan.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-inspector-scan.dev",
			clientEndpoint: aws.String("https://client-inspector-scan.dev"),
			expectURL:      aws.String("https://client-inspector-scan.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_INSPECTOR_SCAN", c.envService)
			}
