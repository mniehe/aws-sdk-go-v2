...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workspaces-web.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-web.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-web.dev",
			expectURL:     aws.String("https://env-workspaces-web.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workspaces-web.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-web.dev",
			expectURL:     aws.String("http://config-workspaces-web.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workspaces-web.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workspaces-web.dev",
			clientEndpoint: aws.String("https://client-workspaces-web.dev"),
			expectURL:      aws.String("https://client-workspaces-web.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKSPACES_WEB", c.envService)
			}
