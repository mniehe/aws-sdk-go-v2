...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-apigatewaymanagementapi.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apigatewaymanagementapi.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apigatewaymanagementapi.dev",
			expectURL:     aws.String("https://env-apigatewaymanagementapi.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-apigatewaymanagementapi.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apigatewaymanagementapi.dev",
			expectURL:     aws.String("http://config-apigatewaymanagementapi.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-apigatewaymanagementapi.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-apigatewaymanagementapi.dev",
			clientEndpoint: aws.String("https://client-apigatewaymanagementapi.dev"),
			expectURL:      aws.String("https://client-apigatewaymanagementapi.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APIGATEWAYMANAGEMENTAPI", c.envService)
			}
