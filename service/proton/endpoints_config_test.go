...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-proton.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-proton.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-proton.dev",
			expectURL:     aws.String("https://env-proton.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-proton.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-proton.dev",
			expectURL:     aws.String("http://config-proton.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-proton.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-proton.dev",
			clientEndpoint: aws.String("https://client-proton.dev"),
			expectURL:      aws.String("https://client-proton.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PROTON", c.envService)
			}
