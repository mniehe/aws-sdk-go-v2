...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cleanrooms.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cleanrooms.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cleanrooms.dev",
			expectURL:     aws.String("https://env-cleanrooms.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cleanrooms.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cleanrooms.dev",
			expectURL:     aws.String("http://config-cleanrooms.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cleanrooms.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cleanrooms.dev",
			clientEndpoint: aws.String("https://client-cleanrooms.dev"),
			expectURL:      aws.String("https://client-cleanrooms.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLEANROOMS", c.envService)
			}
