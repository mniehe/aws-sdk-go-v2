...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lookoutmetrics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutmetrics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutmetrics.dev",
			expectURL:     aws.String("https://env-lookoutmetrics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lookoutmetrics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutmetrics.dev",
			expectURL:     aws.String("http://config-lookoutmetrics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lookoutmetrics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lookoutmetrics.dev",
			clientEndpoint: aws.String("https://client-lookoutmetrics.dev"),
			expectURL:      aws.String("https://client-lookoutmetrics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LOOKOUTMETRICS", c.envService)
			}
