...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-networkmanager.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkmanager.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkmanager.dev",
			expectURL:     aws.String("https://env-networkmanager.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-networkmanager.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-networkmanager.dev",
			expectURL:     aws.String("http://config-networkmanager.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-networkmanager.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-networkmanager.dev",
			clientEndpoint: aws.String("https://client-networkmanager.dev"),
			expectURL:      aws.String("https://client-networkmanager.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NETWORKMANAGER", c.envService)
			}
