...
// github.com/mniehe/aws-sdk-go-v2/service/neptunedata/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// github.com/mniehe/aws-sdk-go-v2/service/neptunedata/internal/document.Interface is
...
// github.com/mniehe/aws-sdk-go-v2/service/neptunedata/internal/document.IsInterface
