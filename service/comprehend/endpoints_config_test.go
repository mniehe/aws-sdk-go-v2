...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-comprehend.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-comprehend.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-comprehend.dev",
			expectURL:     aws.String("https://env-comprehend.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-comprehend.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-comprehend.dev",
			expectURL:     aws.String("http://config-comprehend.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-comprehend.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-comprehend.dev",
			clientEndpoint: aws.String("https://client-comprehend.dev"),
			expectURL:      aws.String("https://client-comprehend.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COMPREHEND", c.envService)
			}
