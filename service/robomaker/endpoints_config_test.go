...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-robomaker.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-robomaker.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-robomaker.dev",
			expectURL:     aws.String("https://env-robomaker.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-robomaker.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-robomaker.dev",
			expectURL:     aws.String("http://config-robomaker.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-robomaker.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-robomaker.dev",
			clientEndpoint: aws.String("https://client-robomaker.dev"),
			expectURL:      aws.String("https://client-robomaker.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ROBOMAKER", c.envService)
			}
