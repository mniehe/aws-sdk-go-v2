...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rum.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rum.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rum.dev",
			expectURL:     aws.String("https://env-rum.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rum.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rum.dev",
			expectURL:     aws.String("http://config-rum.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rum.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rum.dev",
			clientEndpoint: aws.String("https://client-rum.dev"),
			expectURL:      aws.String("https://client-rum.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RUM", c.envService)
			}
