...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sms.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sms.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sms.dev",
			expectURL:     aws.String("https://env-sms.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sms.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sms.dev",
			expectURL:     aws.String("http://config-sms.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sms.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sms.dev",
			clientEndpoint: aws.String("https://client-sms.dev"),
			expectURL:      aws.String("https://client-sms.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SMS", c.envService)
			}
