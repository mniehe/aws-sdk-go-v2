...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-budgets.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-budgets.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-budgets.dev",
			expectURL:     aws.String("https://env-budgets.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-budgets.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-budgets.dev",
			expectURL:     aws.String("http://config-budgets.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-budgets.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-budgets.dev",
			clientEndpoint: aws.String("https://client-budgets.dev"),
			expectURL:      aws.String("https://client-budgets.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BUDGETS", c.envService)
			}
