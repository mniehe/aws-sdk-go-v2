...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-auditmanager.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auditmanager.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auditmanager.dev",
			expectURL:     aws.String("https://env-auditmanager.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-auditmanager.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auditmanager.dev",
			expectURL:     aws.String("http://config-auditmanager.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-auditmanager.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-auditmanager.dev",
			clientEndpoint: aws.String("https://client-auditmanager.dev"),
			expectURL:      aws.String("https://client-auditmanager.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AUDITMANAGER", c.envService)
			}
