...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-transcribe-streaming.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transcribe-streaming.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transcribe-streaming.dev",
			expectURL:     aws.String("https://env-transcribe-streaming.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-transcribe-streaming.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-transcribe-streaming.dev",
			expectURL:     aws.String("http://config-transcribe-streaming.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-transcribe-streaming.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-transcribe-streaming.dev",
			clientEndpoint: aws.String("https://client-transcribe-streaming.dev"),
			expectURL:      aws.String("https://client-transcribe-streaming.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TRANSCRIBE_STREAMING", c.envService)
			}
