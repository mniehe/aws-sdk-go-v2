...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-entityresolution.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-entityresolution.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-entityresolution.dev",
			expectURL:     aws.String("https://env-entityresolution.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-entityresolution.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-entityresolution.dev",
			expectURL:     aws.String("http://config-entityresolution.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-entityresolution.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-entityresolution.dev",
			clientEndpoint: aws.String("https://client-entityresolution.dev"),
			expectURL:      aws.String("https://client-entityresolution.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ENTITYRESOLUTION", c.envService)
			}
