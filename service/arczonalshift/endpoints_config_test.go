...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-arc-zonal-shift.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-arc-zonal-shift.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-arc-zonal-shift.dev",
			expectURL:     aws.String("https://env-arc-zonal-shift.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-arc-zonal-shift.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-arc-zonal-shift.dev",
			expectURL:     aws.String("http://config-arc-zonal-shift.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-arc-zonal-shift.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-arc-zonal-shift.dev",
			clientEndpoint: aws.String("https://client-arc-zonal-shift.dev"),
			expectURL:      aws.String("https://client-arc-zonal-shift.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ARC_ZONAL_SHIFT", c.envService)
			}
