...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-evidently.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-evidently.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-evidently.dev",
			expectURL:     aws.String("https://env-evidently.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-evidently.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-evidently.dev",
			expectURL:     aws.String("http://config-evidently.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-evidently.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-evidently.dev",
			clientEndpoint: aws.String("https://client-evidently.dev"),
			expectURL:      aws.String("https://client-evidently.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EVIDENTLY", c.envService)
			}
