...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotfleethub.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotfleethub.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotfleethub.dev",
			expectURL:     aws.String("https://env-iotfleethub.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotfleethub.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotfleethub.dev",
			expectURL:     aws.String("http://config-iotfleethub.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotfleethub.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotfleethub.dev",
			clientEndpoint: aws.String("https://client-iotfleethub.dev"),
			expectURL:      aws.String("https://client-iotfleethub.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTFLEETHUB", c.envService)
			}
