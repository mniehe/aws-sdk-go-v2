...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sagemaker.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker.dev",
			expectURL:     aws.String("https://env-sagemaker.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sagemaker.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker.dev",
			expectURL:     aws.String("http://config-sagemaker.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sagemaker.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sagemaker.dev",
			clientEndpoint: aws.String("https://client-sagemaker.dev"),
			expectURL:      aws.String("https://client-sagemaker.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAGEMAKER", c.envService)
			}
