...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-quicksight.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-quicksight.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-quicksight.dev",
			expectURL:     aws.String("https://env-quicksight.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-quicksight.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-quicksight.dev",
			expectURL:     aws.String("http://config-quicksight.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-quicksight.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-quicksight.dev",
			clientEndpoint: aws.String("https://client-quicksight.dev"),
			expectURL:      aws.String("https://client-quicksight.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QUICKSIGHT", c.envService)
			}
