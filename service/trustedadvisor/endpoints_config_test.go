...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-trustedadvisor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-trustedadvisor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-trustedadvisor.dev",
			expectURL:     aws.String("https://env-trustedadvisor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-trustedadvisor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-trustedadvisor.dev",
			expectURL:     aws.String("http://config-trustedadvisor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-trustedadvisor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-trustedadvisor.dev",
			clientEndpoint: aws.String("https://client-trustedadvisor.dev"),
			expectURL:      aws.String("https://client-trustedadvisor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TRUSTEDADVISOR", c.envService)
			}
