...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-chime-sdk-messaging.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-messaging.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-messaging.dev",
			expectURL:     aws.String("https://env-chime-sdk-messaging.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-chime-sdk-messaging.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-messaging.dev",
			expectURL:     aws.String("http://config-chime-sdk-messaging.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-chime-sdk-messaging.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-chime-sdk-messaging.dev",
			clientEndpoint: aws.String("https://client-chime-sdk-messaging.dev"),
			expectURL:      aws.String("https://client-chime-sdk-messaging.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CHIME_SDK_MESSAGING", c.envService)
			}
