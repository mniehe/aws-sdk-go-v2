...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-connectcases.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectcases.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectcases.dev",
			expectURL:     aws.String("https://env-connectcases.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-connectcases.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectcases.dev",
			expectURL:     aws.String("http://config-connectcases.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-connectcases.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-connectcases.dev",
			clientEndpoint: aws.String("https://client-connectcases.dev"),
			expectURL:      aws.String("https://client-connectcases.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONNECTCASES", c.envService)
			}
