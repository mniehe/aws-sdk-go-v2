...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codestar-notifications.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar-notifications.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar-notifications.dev",
			expectURL:     aws.String("https://env-codestar-notifications.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codestar-notifications.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar-notifications.dev",
			expectURL:     aws.String("http://config-codestar-notifications.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codestar-notifications.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codestar-notifications.dev",
			clientEndpoint: aws.String("https://client-codestar-notifications.dev"),
			expectURL:      aws.String("https://client-codestar-notifications.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODESTAR_NOTIFICATIONS", c.envService)
			}
