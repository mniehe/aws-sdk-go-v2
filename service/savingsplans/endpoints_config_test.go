...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-savingsplans.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-savingsplans.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-savingsplans.dev",
			expectURL:     aws.String("https://env-savingsplans.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-savingsplans.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-savingsplans.dev",
			expectURL:     aws.String("http://config-savingsplans.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-savingsplans.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-savingsplans.dev",
			clientEndpoint: aws.String("https://client-savingsplans.dev"),
			expectURL:      aws.String("https://client-savingsplans.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAVINGSPLANS", c.envService)
			}
