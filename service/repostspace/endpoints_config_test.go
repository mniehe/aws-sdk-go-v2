...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-repostspace.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-repostspace.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-repostspace.dev",
			expectURL:     aws.String("https://env-repostspace.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-repostspace.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-repostspace.dev",
			expectURL:     aws.String("http://config-repostspace.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-repostspace.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-repostspace.dev",
			clientEndpoint: aws.String("https://client-repostspace.dev"),
			expectURL:      aws.String("https://client-repostspace.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_REPOSTSPACE", c.envService)
			}
