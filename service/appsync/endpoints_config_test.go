...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appsync.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appsync.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appsync.dev",
			expectURL:     aws.String("https://env-appsync.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appsync.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appsync.dev",
			expectURL:     aws.String("http://config-appsync.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appsync.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appsync.dev",
			clientEndpoint: aws.String("https://client-appsync.dev"),
			expectURL:      aws.String("https://client-appsync.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPSYNC", c.envService)
			}
