...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-braket.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-braket.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-braket.dev",
			expectURL:     aws.String("https://env-braket.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-braket.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-braket.dev",
			expectURL:     aws.String("http://config-braket.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-braket.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-braket.dev",
			clientEndpoint: aws.String("https://client-braket.dev"),
			expectURL:      aws.String("https://client-braket.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BRAKET", c.envService)
			}
