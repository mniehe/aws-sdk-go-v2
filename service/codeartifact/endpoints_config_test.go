...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codeartifact.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeartifact.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeartifact.dev",
			expectURL:     aws.String("https://env-codeartifact.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codeartifact.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeartifact.dev",
			expectURL:     aws.String("http://config-codeartifact.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codeartifact.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codeartifact.dev",
			clientEndpoint: aws.String("https://client-codeartifact.dev"),
			expectURL:      aws.String("https://client-codeartifact.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEARTIFACT", c.envService)
			}
