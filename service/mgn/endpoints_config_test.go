...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mgn.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mgn.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mgn.dev",
			expectURL:     aws.String("https://env-mgn.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mgn.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mgn.dev",
			expectURL:     aws.String("http://config-mgn.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mgn.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mgn.dev",
			clientEndpoint: aws.String("https://client-mgn.dev"),
			expectURL:      aws.String("https://client-mgn.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MGN", c.envService)
			}
