...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-neptune.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptune.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptune.dev",
			expectURL:     aws.String("https://env-neptune.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-neptune.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-neptune.dev",
			expectURL:     aws.String("http://config-neptune.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-neptune.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-neptune.dev",
			clientEndpoint: aws.String("https://client-neptune.dev"),
			expectURL:      aws.String("https://client-neptune.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_NEPTUNE", c.envService)
			}
