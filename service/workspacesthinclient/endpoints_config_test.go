...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workspaces-thin-client.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-thin-client.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-thin-client.dev",
			expectURL:     aws.String("https://env-workspaces-thin-client.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workspaces-thin-client.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workspaces-thin-client.dev",
			expectURL:     aws.String("http://config-workspaces-thin-client.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workspaces-thin-client.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workspaces-thin-client.dev",
			clientEndpoint: aws.String("https://client-workspaces-thin-client.dev"),
			expectURL:      aws.String("https://client-workspaces-thin-client.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKSPACES_THIN_CLIENT", c.envService)
			}
