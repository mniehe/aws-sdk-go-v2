...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-groundstation.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-groundstation.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-groundstation.dev",
			expectURL:     aws.String("https://env-groundstation.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-groundstation.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-groundstation.dev",
			expectURL:     aws.String("http://config-groundstation.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-groundstation.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-groundstation.dev",
			clientEndpoint: aws.String("https://client-groundstation.dev"),
			expectURL:      aws.String("https://client-groundstation.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GROUNDSTATION", c.envService)
			}
