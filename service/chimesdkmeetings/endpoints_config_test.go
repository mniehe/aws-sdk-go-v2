...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-chime-sdk-meetings.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-meetings.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-meetings.dev",
			expectURL:     aws.String("https://env-chime-sdk-meetings.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-chime-sdk-meetings.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-chime-sdk-meetings.dev",
			expectURL:     aws.String("http://config-chime-sdk-meetings.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-chime-sdk-meetings.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-chime-sdk-meetings.dev",
			clientEndpoint: aws.String("https://client-chime-sdk-meetings.dev"),
			expectURL:      aws.String("https://client-chime-sdk-meetings.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CHIME_SDK_MEETINGS", c.envService)
			}
