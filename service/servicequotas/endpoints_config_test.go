...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-service-quotas.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-quotas.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-quotas.dev",
			expectURL:     aws.String("https://env-service-quotas.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-service-quotas.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-service-quotas.dev",
			expectURL:     aws.String("http://config-service-quotas.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-service-quotas.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-service-quotas.dev",
			clientEndpoint: aws.String("https://client-service-quotas.dev"),
			expectURL:      aws.String("https://client-service-quotas.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SERVICE_QUOTAS", c.envService)
			}
