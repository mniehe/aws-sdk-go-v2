...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sso.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sso.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sso.dev",
			expectURL:     aws.String("https://env-sso.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sso.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sso.dev",
			expectURL:     aws.String("http://config-sso.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sso.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sso.dev",
			clientEndpoint: aws.String("https://client-sso.dev"),
			expectURL:      aws.String("https://client-sso.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSO", c.envService)
			}
