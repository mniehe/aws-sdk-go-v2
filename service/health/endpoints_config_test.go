...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-health.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-health.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-health.dev",
			expectURL:     aws.String("https://env-health.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-health.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-health.dev",
			expectURL:     aws.String("http://config-health.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-health.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-health.dev",
			clientEndpoint: aws.String("https://client-health.dev"),
			expectURL:      aws.String("https://client-health.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_HEALTH", c.envService)
			}
