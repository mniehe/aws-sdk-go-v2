...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codebuild.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codebuild.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codebuild.dev",
			expectURL:     aws.String("https://env-codebuild.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codebuild.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codebuild.dev",
			expectURL:     aws.String("http://config-codebuild.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codebuild.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codebuild.dev",
			clientEndpoint: aws.String("https://client-codebuild.dev"),
			expectURL:      aws.String("https://client-codebuild.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEBUILD", c.envService)
			}
