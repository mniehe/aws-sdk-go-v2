...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-launch-wizard.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-launch-wizard.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-launch-wizard.dev",
			expectURL:     aws.String("https://env-launch-wizard.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-launch-wizard.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-launch-wizard.dev",
			expectURL:     aws.String("http://config-launch-wizard.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-launch-wizard.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-launch-wizard.dev",
			clientEndpoint: aws.String("https://client-launch-wizard.dev"),
			expectURL:      aws.String("https://client-launch-wizard.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LAUNCH_WIZARD", c.envService)
			}
