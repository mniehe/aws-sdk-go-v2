...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-oam.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-oam.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-oam.dev",
			expectURL:     aws.String("https://env-oam.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-oam.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-oam.dev",
			expectURL:     aws.String("http://config-oam.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-oam.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-oam.dev",
			clientEndpoint: aws.String("https://client-oam.dev"),
			expectURL:      aws.String("https://client-oam.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OAM", c.envService)
			}
