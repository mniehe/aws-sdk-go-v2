...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codecatalyst.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codecatalyst.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codecatalyst.dev",
			expectURL:     aws.String("https://env-codecatalyst.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codecatalyst.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codecatalyst.dev",
			expectURL:     aws.String("http://config-codecatalyst.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codecatalyst.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codecatalyst.dev",
			clientEndpoint: aws.String("https://client-codecatalyst.dev"),
			expectURL:      aws.String("https://client-codecatalyst.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODECATALYST", c.envService)
			}
