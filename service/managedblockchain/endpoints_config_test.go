...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-managedblockchain.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-managedblockchain.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-managedblockchain.dev",
			expectURL:     aws.String("https://env-managedblockchain.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-managedblockchain.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-managedblockchain.dev",
			expectURL:     aws.String("http://config-managedblockchain.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-managedblockchain.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-managedblockchain.dev",
			clientEndpoint: aws.String("https://client-managedblockchain.dev"),
			expectURL:      aws.String("https://client-managedblockchain.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MANAGEDBLOCKCHAIN", c.envService)
			}
