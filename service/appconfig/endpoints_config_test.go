...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appconfig.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appconfig.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appconfig.dev",
			expectURL:     aws.String("https://env-appconfig.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appconfig.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appconfig.dev",
			expectURL:     aws.String("http://config-appconfig.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appconfig.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appconfig.dev",
			clientEndpoint: aws.String("https://client-appconfig.dev"),
			expectURL:      aws.String("https://client-appconfig.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPCONFIG", c.envService)
			}
