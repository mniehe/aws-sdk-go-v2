...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-docdb.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-docdb.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-docdb.dev",
			expectURL:     aws.String("https://env-docdb.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-docdb.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-docdb.dev",
			expectURL:     aws.String("http://config-docdb.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-docdb.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-docdb.dev",
			clientEndpoint: aws.String("https://client-docdb.dev"),
			expectURL:      aws.String("https://client-docdb.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DOCDB", c.envService)
			}
