...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-database-migration-service.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-database-migration-service.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-database-migration-service.dev",
			expectURL:     aws.String("https://env-database-migration-service.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-database-migration-service.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-database-migration-service.dev",
			expectURL:     aws.String("http://config-database-migration-service.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-database-migration-service.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-database-migration-service.dev",
			clientEndpoint: aws.String("https://client-database-migration-service.dev"),
			expectURL:      aws.String("https://client-database-migration-service.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DATABASE_MIGRATION_SERVICE", c.envService)
			}
