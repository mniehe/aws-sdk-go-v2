...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-datazone.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-datazone.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-datazone.dev",
			expectURL:     aws.String("https://env-datazone.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-datazone.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-datazone.dev",
			expectURL:     aws.String("http://config-datazone.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-datazone.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-datazone.dev",
			clientEndpoint: aws.String("https://client-datazone.dev"),
			expectURL:      aws.String("https://client-datazone.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DATAZONE", c.envService)
			}
