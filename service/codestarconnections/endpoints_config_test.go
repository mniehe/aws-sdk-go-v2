...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codestar-connections.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar-connections.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar-connections.dev",
			expectURL:     aws.String("https://env-codestar-connections.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codestar-connections.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codestar-connections.dev",
			expectURL:     aws.String("http://config-codestar-connections.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codestar-connections.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codestar-connections.dev",
			clientEndpoint: aws.String("https://client-codestar-connections.dev"),
			expectURL:      aws.String("https://client-codestar-connections.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODESTAR_CONNECTIONS", c.envService)
			}
