...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sagemaker-geospatial.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-geospatial.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-geospatial.dev",
			expectURL:     aws.String("https://env-sagemaker-geospatial.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sagemaker-geospatial.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-geospatial.dev",
			expectURL:     aws.String("http://config-sagemaker-geospatial.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sagemaker-geospatial.dev",
			...
			expectURL:      aws.String("https://client-sagemaker-geospatial.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAGEMAKER_GEOSPATIAL", c.envService)
			}
