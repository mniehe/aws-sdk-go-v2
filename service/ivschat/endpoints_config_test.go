...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ivschat.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivschat.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivschat.dev",
			expectURL:     aws.String("https://env-ivschat.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ivschat.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ivschat.dev",
			expectURL:     aws.String("http://config-ivschat.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ivschat.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ivschat.dev",
			clientEndpoint: aws.String("https://client-ivschat.dev"),
			expectURL:      aws.String("https://client-ivschat.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IVSCHAT", c.envService)
			}
