...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-amp.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amp.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amp.dev",
			expectURL:     aws.String("https://env-amp.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-amp.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-amp.dev",
			expectURL:     aws.String("http://config-amp.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-amp.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-amp.dev",
			clientEndpoint: aws.String("https://client-amp.dev"),
			expectURL:      aws.String("https://client-amp.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AMP", c.envService)
			}
