...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mediatailor.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediatailor.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediatailor.dev",
			expectURL:     aws.String("https://env-mediatailor.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mediatailor.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediatailor.dev",
			expectURL:     aws.String("http://config-mediatailor.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mediatailor.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mediatailor.dev",
			clientEndpoint: aws.String("https://client-mediatailor.dev"),
			expectURL:      aws.String("https://client-mediatailor.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIATAILOR", c.envService)
			}
