...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-snow-device-management.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snow-device-management.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snow-device-management.dev",
			expectURL:     aws.String("https://env-snow-device-management.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-snow-device-management.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snow-device-management.dev",
			expectURL:     aws.String("http://config-snow-device-management.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-snow-device-management.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-snow-device-management.dev",
			clientEndpoint: aws.String("https://client-snow-device-management.dev"),
			expectURL:      aws.String("https://client-snow-device-management.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SNOW_DEVICE_MANAGEMENT", c.envService)
			}
