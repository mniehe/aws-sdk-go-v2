...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-elastic-transcoder.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-transcoder.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-transcoder.dev",
			expectURL:     aws.String("https://env-elastic-transcoder.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-elastic-transcoder.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elastic-transcoder.dev",
			expectURL:     aws.String("http://config-elastic-transcoder.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-elastic-transcoder.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-elastic-transcoder.dev",
			clientEndpoint: aws.String("https://client-elastic-transcoder.dev"),
			expectURL:      aws.String("https://client-elastic-transcoder.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ELASTIC_TRANSCODER", c.envService)
			}
