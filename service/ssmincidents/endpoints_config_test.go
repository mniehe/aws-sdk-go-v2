...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ssm-incidents.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-incidents.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-incidents.dev",
			expectURL:     aws.String("https://env-ssm-incidents.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ssm-incidents.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-incidents.dev",
			expectURL:     aws.String("http://config-ssm-incidents.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ssm-incidents.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ssm-incidents.dev",
			clientEndpoint: aws.String("https://client-ssm-incidents.dev"),
			expectURL:      aws.String("https://client-ssm-incidents.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSM_INCIDENTS", c.envService)
			}
