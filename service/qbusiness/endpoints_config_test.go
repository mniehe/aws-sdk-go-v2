...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-qbusiness.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qbusiness.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qbusiness.dev",
			expectURL:     aws.String("https://env-qbusiness.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-qbusiness.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qbusiness.dev",
			expectURL:     aws.String("http://config-qbusiness.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-qbusiness.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-qbusiness.dev",
			clientEndpoint: aws.String("https://client-qbusiness.dev"),
			expectURL:      aws.String("https://client-qbusiness.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QBUSINESS", c.envService)
			}
