...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mturk.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mturk.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mturk.dev",
			expectURL:     aws.String("https://env-mturk.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mturk.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mturk.dev",
			expectURL:     aws.String("http://config-mturk.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mturk.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mturk.dev",
			clientEndpoint: aws.String("https://client-mturk.dev"),
			expectURL:      aws.String("https://client-mturk.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MTURK", c.envService)
			}
