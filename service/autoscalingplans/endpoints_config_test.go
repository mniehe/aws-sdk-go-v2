...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-auto-scaling-plans.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auto-scaling-plans.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auto-scaling-plans.dev",
			expectURL:     aws.String("https://env-auto-scaling-plans.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-auto-scaling-plans.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-auto-scaling-plans.dev",
			expectURL:     aws.String("http://config-auto-scaling-plans.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-auto-scaling-plans.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-auto-scaling-plans.dev",
			clientEndpoint: aws.String("https://client-auto-scaling-plans.dev"),
			expectURL:      aws.String("https://client-auto-scaling-plans.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_AUTO_SCALING_PLANS", c.envService)
			}
