...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sfn.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sfn.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sfn.dev",
			expectURL:     aws.String("https://env-sfn.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sfn.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sfn.dev",
			expectURL:     aws.String("http://config-sfn.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sfn.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sfn.dev",
			clientEndpoint: aws.String("https://client-sfn.dev"),
			expectURL:      aws.String("https://client-sfn.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SFN", c.envService)
			}
