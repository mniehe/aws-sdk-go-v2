...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mediapackage-vod.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediapackage-vod.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediapackage-vod.dev",
			expectURL:     aws.String("https://env-mediapackage-vod.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mediapackage-vod.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mediapackage-vod.dev",
			expectURL:     aws.String("http://config-mediapackage-vod.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mediapackage-vod.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mediapackage-vod.dev",
			clientEndpoint: aws.String("https://client-mediapackage-vod.dev"),
			expectURL:      aws.String("https://client-mediapackage-vod.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIAPACKAGE_VOD", c.envService)
			}
