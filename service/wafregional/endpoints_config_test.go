...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-waf-regional.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-waf-regional.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-waf-regional.dev",
			expectURL:     aws.String("https://env-waf-regional.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-waf-regional.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-waf-regional.dev",
			expectURL:     aws.String("http://config-waf-regional.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-waf-regional.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-waf-regional.dev",
			clientEndpoint: aws.String("https://client-waf-regional.dev"),
			expectURL:      aws.String("https://client-waf-regional.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WAF_REGIONAL", c.envService)
			}
