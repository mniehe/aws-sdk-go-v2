...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-opsworks.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opsworks.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opsworks.dev",
			expectURL:     aws.String("https://env-opsworks.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-opsworks.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-opsworks.dev",
			expectURL:     aws.String("http://config-opsworks.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-opsworks.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-opsworks.dev",
			clientEndpoint: aws.String("https://client-opsworks.dev"),
			expectURL:      aws.String("https://client-opsworks.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_OPSWORKS", c.envService)
			}
