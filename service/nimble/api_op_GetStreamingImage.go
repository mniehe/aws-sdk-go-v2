...
func (c *Client) addOperationGetStreamingImageMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetStreamingImage"); err != nil {
...
// Wait calls the waiter function for StreamingImageReady waiter. The maxWaitDur
