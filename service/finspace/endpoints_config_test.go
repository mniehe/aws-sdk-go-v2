...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-finspace.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-finspace.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-finspace.dev",
			expectURL:     aws.String("https://env-finspace.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-finspace.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-finspace.dev",
			expectURL:     aws.String("http://config-finspace.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-finspace.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-finspace.dev",
			clientEndpoint: aws.String("https://client-finspace.dev"),
			expectURL:      aws.String("https://client-finspace.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FINSPACE", c.envService)
			}
