...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-kendra-ranking.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kendra-ranking.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kendra-ranking.dev",
			expectURL:     aws.String("https://env-kendra-ranking.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-kendra-ranking.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kendra-ranking.dev",
			expectURL:     aws.String("http://config-kendra-ranking.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-kendra-ranking.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-kendra-ranking.dev",
			clientEndpoint: aws.String("https://client-kendra-ranking.dev"),
			expectURL:      aws.String("https://client-kendra-ranking.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KENDRA_RANKING", c.envService)
			}
