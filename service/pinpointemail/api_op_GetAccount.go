...
type GetAccountOutput struct {
	...
	// second (your maximum sending rate) is 1. If the value is true , then your
	// account has production access. When your account has production access, you can
	// send email to any address. The sending quota and maximum sending rate for your
