...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pinpoint-email.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint-email.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint-email.dev",
			expectURL:     aws.String("https://env-pinpoint-email.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pinpoint-email.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint-email.dev",
			expectURL:     aws.String("http://config-pinpoint-email.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pinpoint-email.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pinpoint-email.dev",
			clientEndpoint: aws.String("https://client-pinpoint-email.dev"),
			expectURL:      aws.String("https://client-pinpoint-email.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PINPOINT_EMAIL", c.envService)
			}
