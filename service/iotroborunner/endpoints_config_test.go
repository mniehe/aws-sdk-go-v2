...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iot-roborunner.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-roborunner.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-roborunner.dev",
			expectURL:     aws.String("https://env-iot-roborunner.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iot-roborunner.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-roborunner.dev",
			expectURL:     aws.String("http://config-iot-roborunner.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iot-roborunner.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iot-roborunner.dev",
			clientEndpoint: aws.String("https://client-iot-roborunner.dev"),
			expectURL:      aws.String("https://client-iot-roborunner.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOT_ROBORUNNER", c.envService)
			}
