...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-textract.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-textract.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-textract.dev",
			expectURL:     aws.String("https://env-textract.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-textract.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-textract.dev",
			expectURL:     aws.String("http://config-textract.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-textract.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-textract.dev",
			clientEndpoint: aws.String("https://client-textract.dev"),
			expectURL:      aws.String("https://client-textract.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_TEXTRACT", c.envService)
			}
