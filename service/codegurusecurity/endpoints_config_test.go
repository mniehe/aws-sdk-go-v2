...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codeguru-security.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguru-security.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguru-security.dev",
			expectURL:     aws.String("https://env-codeguru-security.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codeguru-security.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codeguru-security.dev",
			expectURL:     aws.String("http://config-codeguru-security.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codeguru-security.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codeguru-security.dev",
			clientEndpoint: aws.String("https://client-codeguru-security.dev"),
			expectURL:      aws.String("https://client-codeguru-security.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEGURU_SECURITY", c.envService)
			}
