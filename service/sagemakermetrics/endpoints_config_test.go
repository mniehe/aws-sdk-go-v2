...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sagemaker-metrics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-metrics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-metrics.dev",
			expectURL:     aws.String("https://env-sagemaker-metrics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sagemaker-metrics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sagemaker-metrics.dev",
			expectURL:     aws.String("http://config-sagemaker-metrics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sagemaker-metrics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sagemaker-metrics.dev",
			clientEndpoint: aws.String("https://client-sagemaker-metrics.dev"),
			expectURL:      aws.String("https://client-sagemaker-metrics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SAGEMAKER_METRICS", c.envService)
			}
