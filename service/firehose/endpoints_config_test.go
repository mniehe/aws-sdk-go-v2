...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-firehose.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-firehose.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-firehose.dev",
			expectURL:     aws.String("https://env-firehose.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-firehose.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-firehose.dev",
			expectURL:     aws.String("http://config-firehose.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-firehose.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-firehose.dev",
			clientEndpoint: aws.String("https://client-firehose.dev"),
			expectURL:      aws.String("https://client-firehose.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FIREHOSE", c.envService)
			}
