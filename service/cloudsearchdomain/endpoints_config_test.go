...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudsearch-domain.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudsearch-domain.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudsearch-domain.dev",
			expectURL:     aws.String("https://env-cloudsearch-domain.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudsearch-domain.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudsearch-domain.dev",
			expectURL:     aws.String("http://config-cloudsearch-domain.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudsearch-domain.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudsearch-domain.dev",
			clientEndpoint: aws.String("https://client-cloudsearch-domain.dev"),
			expectURL:      aws.String("https://client-cloudsearch-domain.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDSEARCH_DOMAIN", c.envService)
			}
