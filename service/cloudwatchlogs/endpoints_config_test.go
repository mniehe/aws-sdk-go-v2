...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudwatch-logs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatch-logs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatch-logs.dev",
			expectURL:     aws.String("https://env-cloudwatch-logs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudwatch-logs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudwatch-logs.dev",
			expectURL:     aws.String("http://config-cloudwatch-logs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudwatch-logs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudwatch-logs.dev",
			clientEndpoint: aws.String("https://client-cloudwatch-logs.dev"),
			expectURL:      aws.String("https://client-cloudwatch-logs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDWATCH_LOGS", c.envService)
			}
