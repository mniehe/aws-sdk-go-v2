...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-guardduty.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-guardduty.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-guardduty.dev",
			expectURL:     aws.String("https://env-guardduty.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-guardduty.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-guardduty.dev",
			expectURL:     aws.String("http://config-guardduty.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-guardduty.dev",
			...
			expectURL:      aws.String("https://client-guardduty.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GUARDDUTY", c.envService)
			}
