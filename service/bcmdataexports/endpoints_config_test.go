...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bcm-data-exports.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-data-exports.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-data-exports.dev",
			expectURL:     aws.String("https://env-bcm-data-exports.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bcm-data-exports.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bcm-data-exports.dev",
			expectURL:     aws.String("http://config-bcm-data-exports.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bcm-data-exports.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bcm-data-exports.dev",
			clientEndpoint: aws.String("https://client-bcm-data-exports.dev"),
			expectURL:      aws.String("https://client-bcm-data-exports.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BCM_DATA_EXPORTS", c.envService)
			}
