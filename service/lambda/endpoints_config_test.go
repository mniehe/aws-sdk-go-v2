...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lambda.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda.dev",
			expectURL:     aws.String("https://env-lambda.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lambda.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lambda.dev",
			expectURL:     aws.String("http://config-lambda.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lambda.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lambda.dev",
			clientEndpoint: aws.String("https://client-lambda.dev"),
			expectURL:      aws.String("https://client-lambda.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LAMBDA", c.envService)
			}
