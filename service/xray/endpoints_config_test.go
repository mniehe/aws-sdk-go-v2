...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-xray.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-xray.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-xray.dev",
			expectURL:     aws.String("https://env-xray.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-xray.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-xray.dev",
			expectURL:     aws.String("http://config-xray.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-xray.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-xray.dev",
			clientEndpoint: aws.String("https://client-xray.dev"),
			expectURL:      aws.String("https://client-xray.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_XRAY", c.envService)
			}
