...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-medialive.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-medialive.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-medialive.dev",
			expectURL:     aws.String("https://env-medialive.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-medialive.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-medialive.dev",
			expectURL:     aws.String("http://config-medialive.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-medialive.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-medialive.dev",
			clientEndpoint: aws.String("https://client-medialive.dev"),
			expectURL:      aws.String("https://client-medialive.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MEDIALIVE", c.envService)
			}
