...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-emr-containers.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-emr-containers.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-emr-containers.dev",
			expectURL:     aws.String("https://env-emr-containers.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-emr-containers.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-emr-containers.dev",
			expectURL:     aws.String("http://config-emr-containers.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-emr-containers.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-emr-containers.dev",
			clientEndpoint: aws.String("https://client-emr-containers.dev"),
			expectURL:      aws.String("https://client-emr-containers.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EMR_CONTAINERS", c.envService)
			}
