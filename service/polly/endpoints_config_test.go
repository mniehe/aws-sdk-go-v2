...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-polly.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-polly.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-polly.dev",
			expectURL:     aws.String("https://env-polly.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-polly.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-polly.dev",
			expectURL:     aws.String("http://config-polly.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-polly.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-polly.dev",
			clientEndpoint: aws.String("https://client-polly.dev"),
			expectURL:      aws.String("https://client-polly.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_POLLY", c.envService)
			}
