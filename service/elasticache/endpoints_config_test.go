...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-elasticache.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elasticache.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elasticache.dev",
			expectURL:     aws.String("https://env-elasticache.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-elasticache.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-elasticache.dev",
			expectURL:     aws.String("http://config-elasticache.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-elasticache.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-elasticache.dev",
			clientEndpoint: aws.String("https://client-elasticache.dev"),
			expectURL:      aws.String("https://client-elasticache.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ELASTICACHE", c.envService)
			}
