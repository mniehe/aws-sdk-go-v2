...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-vpc-lattice.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-vpc-lattice.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-vpc-lattice.dev",
			expectURL:     aws.String("https://env-vpc-lattice.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-vpc-lattice.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-vpc-lattice.dev",
			expectURL:     aws.String("http://config-vpc-lattice.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-vpc-lattice.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-vpc-lattice.dev",
			clientEndpoint: aws.String("https://client-vpc-lattice.dev"),
			expectURL:      aws.String("https://client-vpc-lattice.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_VPC_LATTICE", c.envService)
			}
