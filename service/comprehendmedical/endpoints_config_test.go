...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-comprehendmedical.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-comprehendmedical.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-comprehendmedical.dev",
			expectURL:     aws.String("https://env-comprehendmedical.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-comprehendmedical.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-comprehendmedical.dev",
			expectURL:     aws.String("http://config-comprehendmedical.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-comprehendmedical.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-comprehendmedical.dev",
			clientEndpoint: aws.String("https://client-comprehendmedical.dev"),
			expectURL:      aws.String("https://client-comprehendmedical.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_COMPREHENDMEDICAL", c.envService)
			}
