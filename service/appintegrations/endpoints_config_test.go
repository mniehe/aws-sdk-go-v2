...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appintegrations.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appintegrations.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appintegrations.dev",
			expectURL:     aws.String("https://env-appintegrations.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appintegrations.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appintegrations.dev",
			expectURL:     aws.String("http://config-appintegrations.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appintegrations.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appintegrations.dev",
			clientEndpoint: aws.String("https://client-appintegrations.dev"),
			expectURL:      aws.String("https://client-appintegrations.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPINTEGRATIONS", c.envService)
			}
