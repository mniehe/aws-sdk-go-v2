...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotanalytics.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotanalytics.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotanalytics.dev",
			expectURL:     aws.String("https://env-iotanalytics.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotanalytics.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotanalytics.dev",
			expectURL:     aws.String("http://config-iotanalytics.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotanalytics.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotanalytics.dev",
			clientEndpoint: aws.String("https://client-iotanalytics.dev"),
			expectURL:      aws.String("https://client-iotanalytics.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTANALYTICS", c.envService)
			}
