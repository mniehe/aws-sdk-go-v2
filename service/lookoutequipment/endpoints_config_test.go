...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-lookoutequipment.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutequipment.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutequipment.dev",
			expectURL:     aws.String("https://env-lookoutequipment.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-lookoutequipment.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-lookoutequipment.dev",
			expectURL:     aws.String("http://config-lookoutequipment.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-lookoutequipment.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-lookoutequipment.dev",
			clientEndpoint: aws.String("https://client-lookoutequipment.dev"),
			expectURL:      aws.String("https://client-lookoutequipment.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LOOKOUTEQUIPMENT", c.envService)
			}
