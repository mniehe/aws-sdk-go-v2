...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-emr.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-emr.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-emr.dev",
			expectURL:     aws.String("https://env-emr.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-emr.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-emr.dev",
			expectURL:     aws.String("http://config-emr.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-emr.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-emr.dev",
			clientEndpoint: aws.String("https://client-emr.dev"),
			expectURL:      aws.String("https://client-emr.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_EMR", c.envService)
			}
