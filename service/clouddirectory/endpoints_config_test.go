...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-clouddirectory.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-clouddirectory.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-clouddirectory.dev",
			expectURL:     aws.String("https://env-clouddirectory.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-clouddirectory.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-clouddirectory.dev",
			expectURL:     aws.String("http://config-clouddirectory.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-clouddirectory.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-clouddirectory.dev",
			clientEndpoint: aws.String("https://client-clouddirectory.dev"),
			expectURL:      aws.String("https://client-clouddirectory.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDDIRECTORY", c.envService)
			}
