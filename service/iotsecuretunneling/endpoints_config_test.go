...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotsecuretunneling.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotsecuretunneling.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotsecuretunneling.dev",
			expectURL:     aws.String("https://env-iotsecuretunneling.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotsecuretunneling.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotsecuretunneling.dev",
			expectURL:     aws.String("http://config-iotsecuretunneling.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotsecuretunneling.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotsecuretunneling.dev",
			clientEndpoint: aws.String("https://client-iotsecuretunneling.dev"),
			expectURL:      aws.String("https://client-iotsecuretunneling.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTSECURETUNNELING", c.envService)
			}
