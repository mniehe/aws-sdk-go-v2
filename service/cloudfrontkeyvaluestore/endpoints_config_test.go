...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cloudfront-keyvaluestore.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudfront-keyvaluestore.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudfront-keyvaluestore.dev",
			expectURL:     aws.String("https://env-cloudfront-keyvaluestore.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cloudfront-keyvaluestore.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cloudfront-keyvaluestore.dev",
			expectURL:     aws.String("http://config-cloudfront-keyvaluestore.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cloudfront-keyvaluestore.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cloudfront-keyvaluestore.dev",
			clientEndpoint: aws.String("https://client-cloudfront-keyvaluestore.dev"),
			expectURL:      aws.String("https://client-cloudfront-keyvaluestore.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLOUDFRONT_KEYVALUESTORE", c.envService)
			}
