...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appfabric.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appfabric.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appfabric.dev",
			expectURL:     aws.String("https://env-appfabric.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appfabric.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appfabric.dev",
			expectURL:     aws.String("http://config-appfabric.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appfabric.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appfabric.dev",
			clientEndpoint: aws.String("https://client-appfabric.dev"),
			expectURL:      aws.String("https://client-appfabric.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPFABRIC", c.envService)
			}
