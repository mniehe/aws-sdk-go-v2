...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ssm-contacts.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-contacts.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-contacts.dev",
			expectURL:     aws.String("https://env-ssm-contacts.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ssm-contacts.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ssm-contacts.dev",
			expectURL:     aws.String("http://config-ssm-contacts.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ssm-contacts.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ssm-contacts.dev",
			clientEndpoint: aws.String("https://client-ssm-contacts.dev"),
			expectURL:      aws.String("https://client-ssm-contacts.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSM_CONTACTS", c.envService)
			}
