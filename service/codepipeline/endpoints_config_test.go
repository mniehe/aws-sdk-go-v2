...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codepipeline.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codepipeline.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codepipeline.dev",
			expectURL:     aws.String("https://env-codepipeline.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codepipeline.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codepipeline.dev",
			expectURL:     aws.String("http://config-codepipeline.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codepipeline.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codepipeline.dev",
			clientEndpoint: aws.String("https://client-codepipeline.dev"),
			expectURL:      aws.String("https://client-codepipeline.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODEPIPELINE", c.envService)
			}
