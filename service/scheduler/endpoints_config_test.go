...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-scheduler.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-scheduler.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-scheduler.dev",
			expectURL:     aws.String("https://env-scheduler.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-scheduler.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-scheduler.dev",
			expectURL:     aws.String("http://config-scheduler.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-scheduler.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-scheduler.dev",
			clientEndpoint: aws.String("https://client-scheduler.dev"),
			expectURL:      aws.String("https://client-scheduler.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SCHEDULER", c.envService)
			}
