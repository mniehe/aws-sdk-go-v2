...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-machine-learning.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-machine-learning.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-machine-learning.dev",
			expectURL:     aws.String("https://env-machine-learning.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-machine-learning.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-machine-learning.dev",
			expectURL:     aws.String("http://config-machine-learning.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-machine-learning.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-machine-learning.dev",
			clientEndpoint: aws.String("https://client-machine-learning.dev"),
			expectURL:      aws.String("https://client-machine-learning.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MACHINE_LEARNING", c.envService)
			}
