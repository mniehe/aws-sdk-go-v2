...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-greengrassv2.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-greengrassv2.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-greengrassv2.dev",
			expectURL:     aws.String("https://env-greengrassv2.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-greengrassv2.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-greengrassv2.dev",
			expectURL:     aws.String("http://config-greengrassv2.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-greengrassv2.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-greengrassv2.dev",
			clientEndpoint: aws.String("https://client-greengrassv2.dev"),
			expectURL:      aws.String("https://client-greengrassv2.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GREENGRASSV2", c.envService)
			}
