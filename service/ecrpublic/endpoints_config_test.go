...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ecr-public.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ecr-public.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ecr-public.dev",
			expectURL:     aws.String("https://env-ecr-public.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ecr-public.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ecr-public.dev",
			expectURL:     aws.String("http://config-ecr-public.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ecr-public.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ecr-public.dev",
			clientEndpoint: aws.String("https://client-ecr-public.dev"),
			expectURL:      aws.String("https://client-ecr-public.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ECR_PUBLIC", c.envService)
			}
