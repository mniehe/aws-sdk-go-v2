...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-sso-admin.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sso-admin.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sso-admin.dev",
			expectURL:     aws.String("https://env-sso-admin.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-sso-admin.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-sso-admin.dev",
			expectURL:     aws.String("http://config-sso-admin.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-sso-admin.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-sso-admin.dev",
			clientEndpoint: aws.String("https://client-sso-admin.dev"),
			expectURL:      aws.String("https://client-sso-admin.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SSO_ADMIN", c.envService)
			}
