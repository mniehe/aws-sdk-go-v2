...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-device-farm.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-device-farm.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-device-farm.dev",
			expectURL:     aws.String("https://env-device-farm.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-device-farm.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-device-farm.dev",
			expectURL:     aws.String("http://config-device-farm.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-device-farm.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-device-farm.dev",
			clientEndpoint: aws.String("https://client-device-farm.dev"),
			expectURL:      aws.String("https://client-device-farm.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DEVICE_FARM", c.envService)
			}
