...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-devops-guru.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-devops-guru.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-devops-guru.dev",
			expectURL:     aws.String("https://env-devops-guru.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-devops-guru.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-devops-guru.dev",
			expectURL:     aws.String("http://config-devops-guru.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-devops-guru.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-devops-guru.dev",
			clientEndpoint: aws.String("https://client-devops-guru.dev"),
			expectURL:      aws.String("https://client-devops-guru.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_DEVOPS_GURU", c.envService)
			}
