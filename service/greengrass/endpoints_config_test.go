...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-greengrass.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-greengrass.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-greengrass.dev",
			expectURL:     aws.String("https://env-greengrass.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-greengrass.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-greengrass.dev",
			expectURL:     aws.String("http://config-greengrass.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-greengrass.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-greengrass.dev",
			clientEndpoint: aws.String("https://client-greengrass.dev"),
			expectURL:      aws.String("https://client-greengrass.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GREENGRASS", c.envService)
			}
