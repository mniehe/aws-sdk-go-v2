...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-codecommit.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codecommit.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codecommit.dev",
			expectURL:     aws.String("https://env-codecommit.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-codecommit.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-codecommit.dev",
			expectURL:     aws.String("http://config-codecommit.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-codecommit.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-codecommit.dev",
			clientEndpoint: aws.String("https://client-codecommit.dev"),
			expectURL:      aws.String("https://client-codecommit.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CODECOMMIT", c.envService)
			}
