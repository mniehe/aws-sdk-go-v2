...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-ecs.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ecs.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ecs.dev",
			expectURL:     aws.String("https://env-ecs.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-ecs.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-ecs.dev",
			expectURL:     aws.String("http://config-ecs.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-ecs.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-ecs.dev",
			clientEndpoint: aws.String("https://client-ecs.dev"),
			expectURL:      aws.String("https://client-ecs.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_ECS", c.envService)
			}
