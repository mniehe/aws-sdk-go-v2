...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-cleanroomsml.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cleanroomsml.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cleanroomsml.dev",
			expectURL:     aws.String("https://env-cleanroomsml.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-cleanroomsml.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-cleanroomsml.dev",
			expectURL:     aws.String("http://config-cleanroomsml.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-cleanroomsml.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-cleanroomsml.dev",
			clientEndpoint: aws.String("https://client-cleanroomsml.dev"),
			expectURL:      aws.String("https://client-cleanroomsml.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CLEANROOMSML", c.envService)
			}
