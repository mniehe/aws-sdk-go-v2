...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iotfleetwise.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotfleetwise.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotfleetwise.dev",
			expectURL:     aws.String("https://env-iotfleetwise.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iotfleetwise.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iotfleetwise.dev",
			expectURL:     aws.String("http://config-iotfleetwise.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iotfleetwise.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iotfleetwise.dev",
			clientEndpoint: aws.String("https://client-iotfleetwise.dev"),
			expectURL:      aws.String("https://client-iotfleetwise.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOTFLEETWISE", c.envService)
			}
