...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-personalize-events.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize-events.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize-events.dev",
			expectURL:     aws.String("https://env-personalize-events.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-personalize-events.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-personalize-events.dev",
			expectURL:     aws.String("http://config-personalize-events.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-personalize-events.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-personalize-events.dev",
			clientEndpoint: aws.String("https://client-personalize-events.dev"),
			expectURL:      aws.String("https://client-personalize-events.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PERSONALIZE_EVENTS", c.envService)
			}
