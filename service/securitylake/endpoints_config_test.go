...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-securitylake.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securitylake.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securitylake.dev",
			expectURL:     aws.String("https://env-securitylake.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-securitylake.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-securitylake.dev",
			expectURL:     aws.String("http://config-securitylake.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-securitylake.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-securitylake.dev",
			clientEndpoint: aws.String("https://client-securitylake.dev"),
			expectURL:      aws.String("https://client-securitylake.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SECURITYLAKE", c.envService)
			}
