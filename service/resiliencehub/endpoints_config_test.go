...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-resiliencehub.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resiliencehub.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resiliencehub.dev",
			expectURL:     aws.String("https://env-resiliencehub.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-resiliencehub.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-resiliencehub.dev",
			expectURL:     aws.String("http://config-resiliencehub.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-resiliencehub.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-resiliencehub.dev",
			clientEndpoint: aws.String("https://client-resiliencehub.dev"),
			expectURL:      aws.String("https://client-resiliencehub.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_RESILIENCEHUB", c.envService)
			}
