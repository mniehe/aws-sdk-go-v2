...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-pinpoint-sms-voice.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint-sms-voice.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint-sms-voice.dev",
			expectURL:     aws.String("https://env-pinpoint-sms-voice.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-pinpoint-sms-voice.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-pinpoint-sms-voice.dev",
			expectURL:     aws.String("http://config-pinpoint-sms-voice.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-pinpoint-sms-voice.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-pinpoint-sms-voice.dev",
			clientEndpoint: aws.String("https://client-pinpoint-sms-voice.dev"),
			expectURL:      aws.String("https://client-pinpoint-sms-voice.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_PINPOINT_SMS_VOICE", c.envService)
			}
