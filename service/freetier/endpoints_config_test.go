...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-freetier.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-freetier.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-freetier.dev",
			expectURL:     aws.String("https://env-freetier.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-freetier.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-freetier.dev",
			expectURL:     aws.String("http://config-freetier.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-freetier.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-freetier.dev",
			clientEndpoint: aws.String("https://client-freetier.dev"),
			expectURL:      aws.String("https://client-freetier.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_FREETIER", c.envService)
			}
