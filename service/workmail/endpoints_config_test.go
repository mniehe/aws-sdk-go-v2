...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-workmail.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workmail.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workmail.dev",
			expectURL:     aws.String("https://env-workmail.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-workmail.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-workmail.dev",
			expectURL:     aws.String("http://config-workmail.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-workmail.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-workmail.dev",
			clientEndpoint: aws.String("https://client-workmail.dev"),
			expectURL:      aws.String("https://client-workmail.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_WORKMAIL", c.envService)
			}
