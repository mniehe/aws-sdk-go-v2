...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-connectparticipant.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectparticipant.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectparticipant.dev",
			expectURL:     aws.String("https://env-connectparticipant.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-connectparticipant.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-connectparticipant.dev",
			expectURL:     aws.String("http://config-connectparticipant.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-connectparticipant.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-connectparticipant.dev",
			clientEndpoint: aws.String("https://client-connectparticipant.dev"),
			expectURL:      aws.String("https://client-connectparticipant.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_CONNECTPARTICIPANT", c.envService)
			}
