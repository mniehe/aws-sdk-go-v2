...
// Returns a list of the administrators in the AppInstance . This API is is no
...
//
// Deprecated: Replaced by ListAppInstanceAdmins in the Amazon Chime SDK Identity
// Namespace
