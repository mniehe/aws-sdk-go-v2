...
// Returns a list of media capture pipelines. This API is is no longer supported
...
//
// Deprecated: Replaced by ListMediaCapturePipelines in the Amazon Chime SDK Media
// Pipelines Namespace
