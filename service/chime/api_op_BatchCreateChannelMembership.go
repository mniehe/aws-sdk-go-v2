...
func (m *endpointPrefix_opBatchCreateChannelMembershipMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opBatchCreateChannelMembershipMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opBatchCreateChannelMembershipMiddleware{}, "ResolveEndpointV2", middleware.After)
}
