...
func (m *endpointPrefix_opCreateChannelModeratorMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opCreateChannelModeratorMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opCreateChannelModeratorMiddleware{}, "ResolveEndpointV2", middleware.After)
}
