...
func (m *endpointPrefix_opUpdateChannelMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opUpdateChannelMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opUpdateChannelMiddleware{}, "ResolveEndpointV2", middleware.After)
}
