...
func (m *endpointPrefix_opDeleteChannelMembershipMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opDeleteChannelMembershipMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opDeleteChannelMembershipMiddleware{}, "ResolveEndpointV2", middleware.After)
}
