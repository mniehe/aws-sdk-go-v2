...
// Returns the full details of an AppInstanceUser . This API is is no longer
...
//
// Deprecated: Replaced by DescribeAppInstanceUser in the Amazon Chime SDK
// Identity Namespace
...
func (m *endpointPrefix_opDescribeAppInstanceUserMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opDescribeAppInstanceUserMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opDescribeAppInstanceUserMiddleware{}, "ResolveEndpointV2", middleware.After)
}
