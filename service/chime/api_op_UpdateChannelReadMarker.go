...
func (m *endpointPrefix_opUpdateChannelReadMarkerMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opUpdateChannelReadMarkerMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opUpdateChannelReadMarkerMiddleware{}, "ResolveEndpointV2", middleware.After)
}
