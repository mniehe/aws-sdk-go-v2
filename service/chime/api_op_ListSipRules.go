...
// Lists the SIP rules under the administrator's AWS account. This API is is no
// longer supported and will not be updated. We recommend using the latest version,
// ListSipRules (https://docs.aws.amazon.com/chime-sdk/latest/APIReference/API_voice-chime_ListSipRules.html)
