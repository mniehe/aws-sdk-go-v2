...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-mq.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mq.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mq.dev",
			expectURL:     aws.String("https://env-mq.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-mq.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-mq.dev",
			expectURL:     aws.String("http://config-mq.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-mq.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-mq.dev",
			clientEndpoint: aws.String("https://client-mq.dev"),
			expectURL:      aws.String("https://client-mq.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_MQ", c.envService)
			}
