...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-appflow.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appflow.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appflow.dev",
			expectURL:     aws.String("https://env-appflow.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-appflow.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-appflow.dev",
			expectURL:     aws.String("http://config-appflow.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-appflow.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-appflow.dev",
			clientEndpoint: aws.String("https://client-appflow.dev"),
			expectURL:      aws.String("https://client-appflow.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPFLOW", c.envService)
			}
