...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-location.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-location.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-location.dev",
			expectURL:     aws.String("https://env-location.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-location.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-location.dev",
			expectURL:     aws.String("http://config-location.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-location.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-location.dev",
			clientEndpoint: aws.String("https://client-location.dev"),
			expectURL:      aws.String("https://client-location.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_LOCATION", c.envService)
			}
