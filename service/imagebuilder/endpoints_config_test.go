...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-imagebuilder.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-imagebuilder.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-imagebuilder.dev",
			expectURL:     aws.String("https://env-imagebuilder.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-imagebuilder.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-imagebuilder.dev",
			expectURL:     aws.String("http://config-imagebuilder.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-imagebuilder.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-imagebuilder.dev",
			clientEndpoint: aws.String("https://client-imagebuilder.dev"),
			expectURL:      aws.String("https://client-imagebuilder.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IMAGEBUILDER", c.envService)
			}
