...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-qldb.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qldb.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qldb.dev",
			expectURL:     aws.String("https://env-qldb.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-qldb.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-qldb.dev",
			expectURL:     aws.String("http://config-qldb.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-qldb.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-qldb.dev",
			clientEndpoint: aws.String("https://client-qldb.dev"),
			expectURL:      aws.String("https://client-qldb.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QLDB", c.envService)
			}
