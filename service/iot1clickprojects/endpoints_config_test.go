...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-iot-1click-projects.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-1click-projects.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-1click-projects.dev",
			expectURL:     aws.String("https://env-iot-1click-projects.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-iot-1click-projects.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-iot-1click-projects.dev",
			expectURL:     aws.String("http://config-iot-1click-projects.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-iot-1click-projects.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-iot-1click-projects.dev",
			clientEndpoint: aws.String("https://client-iot-1click-projects.dev"),
			expectURL:      aws.String("https://client-iot-1click-projects.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_IOT_1CLICK_PROJECTS", c.envService)
			}
