...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-servicediscovery.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-servicediscovery.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-servicediscovery.dev",
			expectURL:     aws.String("https://env-servicediscovery.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-servicediscovery.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-servicediscovery.dev",
			expectURL:     aws.String("http://config-servicediscovery.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-servicediscovery.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-servicediscovery.dev",
			clientEndpoint: aws.String("https://client-servicediscovery.dev"),
			expectURL:      aws.String("https://client-servicediscovery.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SERVICEDISCOVERY", c.envService)
			}
